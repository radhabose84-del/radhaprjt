...
namespace BackgroundService.Infrastructure.Data.Notification.Configurations
{
    public class NotificationConfigConfiguration : IEntityTypeConfiguration<NotificationConfig>
    {
        public void Configure(EntityTypeBuilder<NotificationConfig> builder)
        {
            ...
            builder.ToTable("NotificationConfig", "AppNotification");
            ...
            builder.Property(t => t.NotificationEventTypeId)
            ...
            builder.HasOne(ac => ac.NotificationEventType)
          .WithMany(am => am.NotificationEventType)
          .HasForeignKey(ac => ac.NotificationEventTypeId)
