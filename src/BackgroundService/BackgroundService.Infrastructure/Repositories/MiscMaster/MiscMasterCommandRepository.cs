...
namespace BackgroundService.Infrastructure.Repositories.MiscMaster
{
    public class MiscMasterCommandRepository  : IMiscMasterCommandRepository
  {
        ...
        public MiscMasterCommandRepository(NotificationDbContext applicationDbContext)
        {
        ...
        public async Task<bool> UpdateAsync(int id, Domain.Entities.Notification.MiscMaster miscMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id, Domain.Entities.Notification.MiscMaster miscMaster)
        {
