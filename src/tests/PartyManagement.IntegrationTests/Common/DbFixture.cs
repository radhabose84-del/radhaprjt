...
namespace PartyManagement.IntegrationTests.Common
{
    ...
    {
        private const string DbName = "PartyManagement_TestDb";
        ...
        private const string TestDbConnection =
            "Server=192.168.1.126;Database=PartyManagement_TestDb;User Id=developer;Password=Dev@#$456;Encrypt=False;TrustServerCertificate=True;MultipleActiveResultSets=true;";
...
";
        ...
        private async Task EnsurePartySchemaAsync()
        {
