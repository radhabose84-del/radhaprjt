...
namespace BudgetManagement.IntegrationTests.Repositories.AuditLog
{
    /// <summary>
    /// BudgetManagement AuditLogRepository wraps IMongoDbContext. Tests verify
    /// interaction against the abstraction without requiring a real MongoDB instance.
    /// </summary>
