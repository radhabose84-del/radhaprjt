...
{
    public sealed class CreateProjectWorkBreakdownStructureCommandValidatorTests
    {
        ...
        [Fact]
        public async Task Validate_ResponsiblePersonTooLong_FailsValidation()
        {
            var cmd = ProjectWorkBreakdownStructureBuilders.ValidCreateCommand(responsiblePerson: new string('A', 201));
            SetupNameNotExists(cmd.ProjectId, cmd.WorkBreakdownStructureName);
        ...
        [Fact]
        public async Task Validate_NullDatesDoNotTriggerDateComparison_PassesValidation()
        {
            var cmd = ProjectWorkBreakdownStructureBuilders.ValidCreateCommand();
            cmd.StartDate = null;
            cmd.EndDate = null;
