...
namespace ProductionManagement.UnitTests.Application.MiscMaster.Commands
{
    public sealed class UpdateMiscMasterCommandHandlerTests
    {
        ...
        private void SetupHappyPath(int returnId = 1)
        {
            ...
            _mockQueryRepo.Setup(r => r.IsMiscMasterLinkedAsync(It.IsAny<int>()))
                .ReturnsAsync(false);
        ...
        public async Task Handle_ValidCommand_ReturnsSuccess()
        {
            ...
            var result = await CreateSut().Handle(
                new UpdateMiscMasterCommand { Id = 1, IsActive = 1 }, CancellationToken.None);
        ...
        public async Task Handle_ValidCommand_CallsUpdateOnce()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.UpdateAsync(It.IsAny<ProductionManagement.Domain.Entities.MiscMaster>()), Times.Once);
        }
        ...
        public async Task Handle_InactivateWhenLinked_ThrowsException()
        {
            ...
            Func<Task> act = async () => await sut.Handle(
                new UpdateMiscMasterCommand { Id = 1, IsActive = 0 }, CancellationToken.None);
