...
{
    public sealed class UpdateYarnConversionHeaderCommandValidatorTests
    {
        ...
        private UpdateYarnConversionHeaderCommandValidator CreateValidator() =>
