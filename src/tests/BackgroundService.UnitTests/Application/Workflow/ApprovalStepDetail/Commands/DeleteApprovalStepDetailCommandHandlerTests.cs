...
{
    public sealed class DeleteApprovalStepDetailCommandHandlerTests
    {
        private readonly Mock<IApprovalStepDetailCommand> _mockCommandRepo = new(MockBehavior.Strict);
        private readonly Mock<IMediator> _mockMediator = new(MockBehavior.Loose);
        private readonly Mock<IMapper> _mockMapper = new(MockBehavior.Loose);

        private DeleteApprovalStepDetailCommandHandler CreateSut() =>
            new(_mockCommandRepo.Object, _mockMediator.Object, _mockMapper.Object);

        private void SetupHappyPath(bool deleteResult = true)
        {
            _mockMapper
                .Setup(m => m.Map<BackgroundService.Domain.Entities.Workflow.ApprovalStepDetail>(It.IsAny<DeleteApprovalStepDetailCommand>()))
                .Returns(new BackgroundService.Domain.Entities.Workflow.ApprovalStepDetail());

            _mockCommandRepo
                .Setup(r => r.DeleteAsync(It.IsAny<int>(), It.IsAny<BackgroundService.Domain.Entities.Workflow.ApprovalStepDetail>()))
        ...
        public async Task Handle_ValidId_ReturnsTrue()
        {
            ...
            var result = await sut.Handle(
                new DeleteApprovalStepDetailCommand { Id = 1 }, CancellationToken.None);
        ...
        public async Task Handle_ValidId_CallsDeleteOnce()
        {
            ...
            await sut.Handle(new DeleteApprovalStepDetailCommand { Id = 1 }, CancellationToken.None);

            _mockCommandRepo.Verify(
                r => r.DeleteAsync(1, It.IsAny<BackgroundService.Domain.Entities.Workflow.ApprovalStepDetail>()),
                Times.Once);
        }
            ...
            _mockMediator.Verify(
                m => m.Publish(
                    It.Is<AuditLogsDomainEvent>(e =>
                        ...
                        e.ActionCode == "APPROVAL_STEP_DETAIL_DELETE"),
        ...
        public async Task Handle_DeleteReturnsFalse_ThrowsExceptionRules()
        {
            ...
            Func<Task> act = async () => await sut.Handle(
                new DeleteApprovalStepDetailCommand { Id = 99 }, CancellationToken.None);
