...
{
    public sealed class DeleteNotificationTemplateCommandValidatorTests
    {
        private readonly Mock<INotificationTemplateQueryRepository> _mockQueryRepo = new(MockBehavior.Strict);

        private DeleteNotificationTemplateCommandValidator CreateValidator() =>
        ...
        {
            var command = new DeleteNotificationTemplateCommand { Id = 1 };
            SetupAllAsyncMocks();
        ...
        {
            var command = new DeleteNotificationTemplateCommand { Id = 0 };
        ...
        {
            var command = new DeleteNotificationTemplateCommand { Id = 99 };
