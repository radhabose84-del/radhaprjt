...
namespace LogisticsManagement.UnitTests.Application.MiscTypeMaster.Commands
{
    public sealed class CreateMiscTypeMasterCommandHandlerTests
    {
        ...
        {
            _mockMapper
                .Setup(m => m.Map<global::LogisticsManagement.Domain.Entities.MiscTypeMaster>(It.IsAny<CreateMiscTypeMasterCommand>()))
                .Returns(MiscTypeMasterBuilders.ValidEntity(0));

            _mockCommandRepo
                .Setup(r => r.CreateAsync(It.IsAny<global::LogisticsManagement.Domain.Entities.MiscTypeMaster>()))
                .ReturnsAsync(newId);
        ...
        public async Task Handle_ValidCommand_CallsCreateOnce()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.CreateAsync(It.IsAny<global::LogisticsManagement.Domain.Entities.MiscTypeMaster>()),
                Times.Once);
        }
