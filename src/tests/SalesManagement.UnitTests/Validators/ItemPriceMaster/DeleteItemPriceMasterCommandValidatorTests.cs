...
{
    public sealed class DeleteItemPriceMasterCommandValidatorTests
    {
        private readonly Mock<IItemPriceMasterQueryRepository> _mockQueryRepo = new(MockBehavior.Strict);

        private DeleteItemPriceMasterCommandValidator CreateValidator()
        ...
        public async Task ValidId_ExistingEntity_PassesValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteItemPriceMasterCommand(1));
        ...
        public async Task Id_Zero_FailsNotEmpty()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteItemPriceMasterCommand(0));
        ...
        public async Task Id_EntityNotFound_FailsValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteItemPriceMasterCommand(999));
        ...
        public async Task Id_ActiveRelationshipsExist_FailsSoftDeleteValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteItemPriceMasterCommand(2));
