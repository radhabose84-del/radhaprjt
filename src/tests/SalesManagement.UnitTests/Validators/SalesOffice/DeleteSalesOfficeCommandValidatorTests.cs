...
{
    public sealed class DeleteSalesOfficeCommandValidatorTests
    {
        private readonly Mock<ISalesOfficeQueryRepository> _mockQueryRepo = new(MockBehavior.Strict);

        private DeleteSalesOfficeCommandValidator CreateValidator()
        ...
        public async Task ValidId_ExistingEntity_PassesValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteSalesOfficeCommand(1));
        ...
        public async Task Id_Zero_FailsNotEmpty()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteSalesOfficeCommand(0));
        ...
        public async Task Id_EntityNotFound_FailsValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteSalesOfficeCommand(999));
        ...
        public async Task Id_ActiveRelationshipsExist_FailsSoftDeleteValidation()
        {
            ...
            var result = await CreateValidator().TestValidateAsync(new DeleteSalesOfficeCommand(2));
