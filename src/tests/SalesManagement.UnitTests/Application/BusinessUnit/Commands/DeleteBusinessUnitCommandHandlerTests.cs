...
namespace SalesManagement.UnitTests.Application.BusinessUnit.Commands
{
    public class DeleteBusinessUnitCommandHandlerTests
    {
        ...
        public async Task Handle_ValidId_ReturnsTrue()
        {
            ...
            var result = await CreateSut().Handle(new DeleteBusinessUnitCommand(1), CancellationToken.None);
        ...
        public async Task Handle_ValidId_CallsSoftDeleteAsync_Once()
        {
            ...
            await CreateSut().Handle(new DeleteBusinessUnitCommand(1), CancellationToken.None);
