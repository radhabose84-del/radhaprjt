...
public sealed class UploadSalesOrderDocumentCommandHandlerTests
{
    private readonly Mock<IMediator> _mockMediator = new(MockBehavior.Loose);
    private readonly Mock<IIPAddressService> _mockIpService = new(MockBehavior.Loose);
    private readonly Mock<ICompanyLookup> _mockCompanyLookup = new(MockBehavior.Loose);
    private readonly Mock<IUnitLookup> _mockUnitLookup = new(MockBehavior.Loose);
    private readonly Mock<ILogger<UploadSalesOrderDocumentCommandHandler>> _mockLogger = new(MockBehavior.Loose);

    private UploadSalesOrderDocumentCommandHandler CreateSut() =>
    ...
    {
        var command = new UploadSalesOrderDocumentCommand { File = null };
    ...
    public async Task Handle_EmptyFile_ThrowsExceptionRules()
    {
        ...
        var command = new UploadSalesOrderDocumentCommand { File = mockFile.Object };
