...
namespace SalesManagement.UnitTests.Application.SalesChannel.Queries
{
    public class GetSalesChannelAutoCompleteQueryHandlerTests
    {
        ...
        {
            _mockMapper.Setup(m => m.Map<List<SalesChannelLookupDto>>(It.IsAny<object>()))
                .Returns<object>(o => o is IEnumerable<SalesChannelLookupDto> e ? e.ToList() : new List<SalesChannelLookupDto>());
            _mockMediator.Setup(m => m.Publish(It.IsAny<INotification>(), It.IsAny<CancellationToken>()))
                .Returns(Task.CompletedTask);
            return new GetSalesChannelAutoCompleteQueryHandler(_mockQueryRepo.Object, _mockMapper.Object, _mockMediator.Object);
        }
