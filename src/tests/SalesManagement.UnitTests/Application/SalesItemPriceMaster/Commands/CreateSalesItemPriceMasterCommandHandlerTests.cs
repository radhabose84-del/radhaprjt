...
{
    public class CreateSalesItemPriceMasterCommandHandlerTests
    {
        ...
        private CreateSalesItemPriceMasterCommandHandler CreateSut() =>
            new CreateSalesItemPriceMasterCommandHandler(
        ...
        private void SetupHappyPath(CreateSalesItemPriceMasterCommand command, int newId = 1)
        {
            var entity = SalesItemPriceMasterBuilders.ValidEntity(newId);
        ...
        public async Task Handle_ValidCommand_CallsCreateAsync_Once()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.CreateAsync(It.IsAny<SalesManagement.Domain.Entities.SalesItemPriceMaster>()),
                Times.Once);
        }
            ...
            _mockMediator.Verify(
                m => m.Publish(
                    It.Is<AuditLogsDomainEvent>(e =>
                        ...
                        e.ActionCode == "SALES_ITEM_PRICE_CREATE" &&
        ...
        {
            var command = SalesItemPriceMasterBuilders.ValidCreateCommand(priceCode: "PC999");
            SetupHappyPath(command, newId: 1);
        ...
        public async Task Handle_ValidCommand_MapsCommandToEntity_Once()
        {
            ...
            _mockMapper.Verify(
                m => m.Map<SalesManagement.Domain.Entities.SalesItemPriceMaster>(command),
                Times.Once);
        }
        ...
        {
            var command = SalesItemPriceMasterBuilders.ValidCreateCommand();
            var capturedEntity = default(SalesManagement.Domain.Entities.SalesItemPriceMaster);

            var entity = new SalesManagement.Domain.Entities.SalesItemPriceMaster
            {
            ...
            _mockCommandRepo
                .Setup(r => r.CreateAsync(It.IsAny<SalesManagement.Domain.Entities.SalesItemPriceMaster>()))
                .Callback<SalesManagement.Domain.Entities.SalesItemPriceMaster>(e => capturedEntity = e)
                .ReturnsAsync(1);
