...
namespace SalesManagement.UnitTests.Application.SalesGroup.Queries
{
    public class GetAllSalesGroupQueryHandlerTests
    {
        ...
        {
            // Arrange
            var query = new GetAllSalesGroupQuery { PageNumber = 1, PageSize = 10, SearchTerm = null };
            var dtoList = new List<SalesGroupDto>
            {
                SalesGroupBuilders.ValidDto(id: 1, name: "Group One"),
                SalesGroupBuilders.ValidDto(id: 2, name: "Group Two")
            };
        ...
        {
            // Arrange
            var query = new GetAllSalesGroupQuery { PageNumber = 2, PageSize = 5, SearchTerm = "Group" };
            var dtoList = new List<SalesGroupDto>
            {
                SalesGroupBuilders.ValidDto(id: 6, name: "Group Six")
            };

            _mockQueryRepo.Setup(r => r.GetAllAsync(2, 5, "Group")).ReturnsAsync((dtoList, 6));
        ...
        {
            // Arrange
            var query = new GetAllSalesGroupQuery { PageNumber = 1, PageSize = 10, SearchTerm = "NOTFOUND" };
            var emptyList = new List<SalesGroupDto>();
        ...
        {
            // Arrange
            var query = new GetAllSalesGroupQuery { PageNumber = 3, PageSize = 20, SearchTerm = "test" };
            var dtoList = new List<SalesGroupDto>();
        ...
        {
            // Arrange
            var query = new GetAllSalesGroupQuery { PageNumber = 1, PageSize = 10 };
            var dtoList = new List<SalesGroupDto>();
