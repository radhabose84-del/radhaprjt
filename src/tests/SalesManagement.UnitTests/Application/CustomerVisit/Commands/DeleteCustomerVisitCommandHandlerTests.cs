...
namespace SalesManagement.UnitTests.Application.CustomerVisit.Commands
{
    public class DeleteCustomerVisitCommandHandlerTests
    {
        ...
        public async Task Handle_ValidId_ReturnsTrue()
        {
            ...
            var result = await CreateSut().Handle(new DeleteCustomerVisitCommand(1), CancellationToken.None);
        ...
        public async Task Handle_ValidId_CallsSoftDeleteAsync_Once()
        {
            ...
            await CreateSut().Handle(new DeleteCustomerVisitCommand(1), CancellationToken.None);
        ...
        public async Task Handle_ValidId_PublishesAuditLogEvent_Once()
        {
            ...
            _mockMediator.Verify(
                m => m.Publish(
                    It.Is<AuditLogsDomainEvent>(e => e.ActionCode == "CUSTOMER_VISIT_DELETE"),
        ...
        public async Task Handle_NonExistentId_ThrowsExceptionRules()
        {
            ...
            Func<Task> act = async () => await sut.Handle(
                new DeleteCustomerVisitCommand(99), CancellationToken.None);
        ...
        public async Task Handle_NonExistentId_DoesNotPublishAuditEvent()
        {
            ...
            var sut = CreateSut();
            try { await sut.Handle(new DeleteCustomerVisitCommand(99), CancellationToken.None); }
            catch { /* expected */ }
