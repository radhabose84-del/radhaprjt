...
public class DeleteSalesLeadCommandHandlerTests
{
    ...
    public async Task Handle_ValidId_ReturnsTrue()
    {
        ...
        var result = await CreateSut().Handle(new DeleteSalesLeadCommand(1), CancellationToken.None);
    ...
    public async Task Handle_ValidId_CallsSoftDeleteAsync_Once()
    {
        ...
        await CreateSut().Handle(new DeleteSalesLeadCommand(1), CancellationToken.None);
    ...
    public async Task Handle_ValidId_PublishesAuditLogEvent_Once()
    {
        ...
        _mockMediator.Verify(
            m => m.Publish(
                It.Is<AuditLogsDomainEvent>(e => e.ActionCode == "SALES_LEAD_DELETE"),
