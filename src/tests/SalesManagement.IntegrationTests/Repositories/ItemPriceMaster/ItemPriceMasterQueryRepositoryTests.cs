...
{
    /// <summary>
    /// Integration tests for ItemPriceMasterQueryRepository.
    /// Verifies Dapper SQL queries against a real SQL Server database.
    ///
    /// ItemPriceMaster JOINs Sales.SalesSegment (same-module FK) for SegmentName,
    ...
    public sealed class ItemPriceMasterQueryRepositoryTests
    {
        private readonly DbFixture _fixture;

        public ItemPriceMasterQueryRepositoryTests(DbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private ItemPriceMasterQueryRepository CreateQueryRepo(
            ...
            Mock<IPaymentTermLookup> paymentTermLookup = null)
        {
            ...
            return new ItemPriceMasterQueryRepository(
                conn,
                itemLookup.Object,
        ...
        {
            await using var ctx = _fixture.CreateFreshDbContext();
            var entity = new Domain.Entities.ItemPriceMaster
            {
                PriceCode      = priceCode,
                ItemId         = itemId,
