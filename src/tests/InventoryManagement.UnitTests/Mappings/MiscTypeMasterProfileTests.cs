...
namespace InventoryManagement.UnitTests.Mappings
{
    public sealed class MiscTypeMasterProfileTests
    {
        ...
        {
            var cmd = new CreateMiscTypeMasterCommand { MiscTypeCode = "TYP001", Description = "Test Type" };

            var entity = _mapper.Map<InventoryManagement.Domain.Entities.MiscTypeMaster>(cmd);
        ...
        {
            var cmd = new UpdateMiscTypeMasterCommand { Id = 1, MiscTypeCode = "TYP001", Description = "Updated", IsActive = 1 };
        ...
        {
            var cmd = new UpdateMiscTypeMasterCommand { Id = 1, MiscTypeCode = "TYP001", Description = "Updated", IsActive = 0 };
