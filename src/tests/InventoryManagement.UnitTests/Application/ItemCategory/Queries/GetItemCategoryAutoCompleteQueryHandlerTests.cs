...
namespace InventoryManagement.UnitTests.Application.ItemCategory.Queries
{
    public sealed class GetItemCategoryAutoCompleteQueryHandlerTests
    {
        ...
        public async Task Handle_ReturnsMatchingItems()
        {
            ...
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), "Elec", false, 0, It.IsAny<int?>(), false))
        ...
        public async Task Handle_EmptyResult_ReturnsEmptyList()
        {
            ...
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), string.Empty, false, 0, It.IsAny<int?>(), false))
        ...
        {
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()))
            ...
            _mockQueryRepo.Verify(r => r.GetItemCategoryAutoCompleteAsync(
                It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()), Times.Once);
        }

        [Fact]
        public async Task Handle_PassesExactModuleIdToRepository()
        {
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<int>(), 77, It.IsAny<bool>()))
                .ReturnsAsync(new List<ItemCategoryAutoCompleteDto>());
            _mockMapper.Setup(m => m.Map<List<ItemCategoryAutoCompleteDto>>(It.IsAny<object>()))
                .Returns(new List<ItemCategoryAutoCompleteDto>());
            _mockMediator.Setup(m => m.Publish(It.IsAny<AuditLogsDomainEvent>(), It.IsAny<CancellationToken>()))
            ...
            _mockQueryRepo.Verify(r => r.GetItemCategoryAutoCompleteAsync(
                It.IsAny<int?>(), "x", false, It.IsAny<int>(), 77, It.IsAny<bool>()), Times.Once);
        }

        [Fact]
        public async Task Handle_NullSearchPattern_PassesEmptyStringToRepo()
        {
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), string.Empty, It.IsAny<bool>(), It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()))
                .ReturnsAsync(new List<ItemCategoryAutoCompleteDto>());
            _mockMapper.Setup(m => m.Map<List<ItemCategoryAutoCompleteDto>>(It.IsAny<object>()))
                .Returns(new List<ItemCategoryAutoCompleteDto>());
            _mockMediator.Setup(m => m.Publish(It.IsAny<AuditLogsDomainEvent>(), It.IsAny<CancellationToken>()))
            ...
            _mockQueryRepo.Verify(r => r.GetItemCategoryAutoCompleteAsync(
                It.IsAny<int?>(), string.Empty, It.IsAny<bool>(), It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()), Times.Once);
        }

        [Fact]
        public async Task Handle_NullIsGroup_PassesFalseToRepo()
        {
            _mockQueryRepo.Setup(r => r.GetItemCategoryAutoCompleteAsync(It.IsAny<int?>(), It.IsAny<string>(), false, It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()))
                .ReturnsAsync(new List<ItemCategoryAutoCompleteDto>());
            _mockMapper.Setup(m => m.Map<List<ItemCategoryAutoCompleteDto>>(It.IsAny<object>()))
                .Returns(new List<ItemCategoryAutoCompleteDto>());
            _mockMediator.Setup(m => m.Publish(It.IsAny<AuditLogsDomainEvent>(), It.IsAny<CancellationToken>()))
            ...
            _mockQueryRepo.Verify(r => r.GetItemCategoryAutoCompleteAsync(
                It.IsAny<int?>(), It.IsAny<string>(), false, It.IsAny<int>(), It.IsAny<int?>(), It.IsAny<bool>()), Times.Once);
        }
