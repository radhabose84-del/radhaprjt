...
{
    public sealed class CreateUOMConversionCommandHandlerTests
    {
        ...
        private CreateUOMConversionCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(int id = 1)
        {
            ...
            _mockMapper
                ...
                .Returns(entity);
            _mockCommandRepo
                .Setup(r => r.CreateAsync(It.IsAny<InventoryManagement.Domain.Entities.UOMConversion>()))
                .ReturnsAsync(entity);
            _mockQueryRepo
        ...
        public async Task Handle_ValidCommand_ReturnsSuccess()
        {
            ...
            var result = await CreateSut().Handle(
                UOMConversionBuilders.ValidCreateCommand(), CancellationToken.None);
        ...
        {
            SetupHappyPath();
            await CreateSut().Handle(UOMConversionBuilders.ValidCreateCommand(), CancellationToken.None);

            _mockCommandRepo.Verify(
                r => r.CreateAsync(It.IsAny<InventoryManagement.Domain.Entities.UOMConversion>()),
                Times.Once);
        }
