...
namespace MaintenanceManagement.IntegrationTests.Common
{
    ...
    {
        private const string DbName = "MaintenanceManagement_TestDb";
        ...
        private const string TestDbConnection =
            "Server=192.168.1.126;Database=MaintenanceManagement_TestDb;User Id=developer;Password=Dev@#$456;Encrypt=False;TrustServerCertificate=True;MultipleActiveResultSets=true;";
...
";
        ...
        private async Task EnsureMaintenanceSchemaAsync()
        {
