...
{
    public sealed class GetWorkingStatusQueryHandlerTests
    {
        private readonly Mock<IAssetMasterGeneralQueryRepository> _mockRepo = new(MockBehavior.Strict);
        private readonly Mock<IMapper> _mockMapper = new(MockBehavior.Loose);

        private FAM.Application.DepreciationGroup.Queries.GetWorkingStatusQuery.GetWorkingStatusQueryHandler CreateSut() =>
        ...
        public async Task Handle_ReturnsSuccess()
        {
            ...
            _mockRepo
                .Setup(r => r.GetWorkingStatusAsync())
            ...
            var result = await CreateSut().Handle(
                new FAM.Application.DepreciationGroup.Queries.GetWorkingStatusQuery.GetWorkingStatusQuery(),
