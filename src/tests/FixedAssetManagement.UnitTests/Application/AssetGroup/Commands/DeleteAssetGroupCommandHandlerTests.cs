...
{
    public sealed class DeleteAssetGroupCommandHandlerTests
    {
        ...
        private readonly Mock<ILogger<DeleteAssetGroupCommandHandler>> _mockLogger = new(MockBehavior.Loose);
        private readonly Mock<IMediator> _mockMediator = new(MockBehavior.Loose);

        private DeleteAssetGroupCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(int id = 1)
        {
            ...
            _mockCommandRepo
                .Setup(r => r.DeleteAsync(id, It.IsAny<FAM.Domain.Entities.AssetGroup>()))
                .ReturnsAsync(id);
        ...
        {
            SetupHappyPath(1);
            var command = AssetGroupBuilders.ValidDeleteCommand();
        ...
        public async Task Handle_ValidId_CallsDeleteOnce()
        {
            ...
            _mockCommandRepo.Verify(r => r.DeleteAsync(It.IsAny<int>(), It.IsAny<FAM.Domain.Entities.AssetGroup>()), Times.Once);
        }
    }
}
