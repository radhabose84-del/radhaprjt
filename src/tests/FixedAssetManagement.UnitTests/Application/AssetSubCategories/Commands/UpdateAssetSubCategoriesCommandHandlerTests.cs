...
{
    public sealed class UpdateAssetSubCategoriesCommandHandlerTests
    {
        ...
        private UpdateAssetSubCategoriesCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(int id = 1)
        {
            ...
            _mockCommandRepo
                .Setup(r => r.UpdateAsync(id, It.IsAny<FAM.Domain.Entities.AssetSubCategories>()))
                .ReturnsAsync(id);
        ...
        public async Task Handle_ValidCommand_CallsUpdateOnce()
        {
            ...
            _mockCommandRepo.Verify(r => r.UpdateAsync(It.IsAny<int>(), It.IsAny<FAM.Domain.Entities.AssetSubCategories>()), Times.Once);
        }
    }
}
