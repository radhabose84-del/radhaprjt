...
namespace FixedAssetManagement.UnitTests.Application.DepreciationGroup.Queries
{
    public sealed class GetDepreciationMethodQueryHandlerTests
    {
        ...
        private FAM.Application.DepreciationGroup.Queries.GetDepreciationMethodQuery.GetDepreciationMethodQueryHandler CreateSut() =>
            new(_mockRepo.Object, _mockMapper.Object);

        [Fact]
        public async Task Handle_ReturnsMethodList()
        {
