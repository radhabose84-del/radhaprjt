...
{
    public sealed class DeleteDepreciationCommandHandlerTests
    {
        ...
        private DeleteDepreciationCommandHandler CreateSut() =>
        ...
        public async Task Handle_AlreadyLocked_ThrowsValidationException()
        {
            ...
            await Assert.ThrowsAsync<ValidationException>(() =>
                CreateSut().Handle(new DeleteDepreciationCommand { FinYearId = 1 }, CancellationToken.None));
        }
        ...
        public async Task Handle_ValidCommand_ReturnsDto()
        {
            ...
            var result = await CreateSut().Handle(
                new DeleteDepreciationCommand { FinYearId = 1 },
        ...
        [Fact]
        public async Task Handle_DeleteFails_ThrowsValidationException()
        {
            _mockQueryRepo
                .Setup(r => r.ExistDataLockedAsync(1))
                .ReturnsAsync(false);
        ...
        public async Task Handle_ValidCommand_PublishesAuditEvent()
        {
            ...
            _mockCommandRepo.Setup(r => r.DeleteAsync(1)).ReturnsAsync(1);

            await CreateSut().Handle(new DeleteDepreciationCommand { FinYearId = 1 }, CancellationToken.None);
