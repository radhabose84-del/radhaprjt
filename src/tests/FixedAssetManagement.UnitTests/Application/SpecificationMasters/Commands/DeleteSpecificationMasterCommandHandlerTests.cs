...
{
    public sealed class DeleteSpecificationMasterCommandHandlerTests
    {
        ...
        private DeleteSpecificationMasterCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(FAM.Domain.Entities.SpecificationMasters entity, SpecificationMasterDTO dto)
        {
            ...
            _mockQueryRepo
                ...
                .ReturnsAsync(false);
            _mockMapper
                .Setup(m => m.Map<FAM.Domain.Entities.SpecificationMasters>(It.IsAny<DeleteSpecificationMasterCommand>()))
                .Returns(entity);
            _mockMapper
                .Setup(m => m.Map<SpecificationMasterDTO>(It.IsAny<FAM.Domain.Entities.SpecificationMasters>()))
                .Returns(dto);
            _mockCommandRepo
                .Setup(r => r.DeleteAsync(It.IsAny<int>(), It.IsAny<FAM.Domain.Entities.SpecificationMasters>()))
                .ReturnsAsync(1);
            _mockMediator
        ...
        {
            var command = SpecificationMasterBuilders.ValidDeleteCommand();
        ...
        public async Task Handle_ValidCommand_CallsDeleteOnce()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.DeleteAsync(It.IsAny<int>(), It.IsAny<FAM.Domain.Entities.SpecificationMasters>()),
                Times.Once);
        }
        ...
        {
            var command = SpecificationMasterBuilders.ValidDeleteCommand(id: 99);
            _mockQueryRepo
            ...
            await act.Should().ThrowAsync<ValidationException>()
                .WithMessage("*Invalid SpecificationMasterID*");
        }
