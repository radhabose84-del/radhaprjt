...
{
    public sealed class UpdateAssetSubGroupCommandHandlerTests
    {
        ...
        private readonly Mock<ILogger<UpdateAssetSubGroupCommandHandler>> _mockLogger = new(MockBehavior.Loose);
        private readonly Mock<IMediator> _mockMediator = new(MockBehavior.Loose);

        private UpdateAssetSubGroupCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(int id = 1)
        {
            ...
            _mockCommandRepo
                .Setup(r => r.UpdateAsync(id, It.IsAny<FAM.Domain.Entities.AssetSubGroup>()))
                .ReturnsAsync(id);
        ...
        public async Task Handle_ValidCommand_CallsUpdateOnce()
        {
            ...
            _mockCommandRepo.Verify(r => r.UpdateAsync(It.IsAny<int>(), It.IsAny<FAM.Domain.Entities.AssetSubGroup>()), Times.Once);
        }
    }
}
