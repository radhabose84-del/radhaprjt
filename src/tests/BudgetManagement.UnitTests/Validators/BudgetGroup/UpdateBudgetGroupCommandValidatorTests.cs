...
{
    public sealed class UpdateBudgetGroupCommandValidatorTests
    {
        ...
        private UpdateBudgetGroupCommandValidator CreateValidator() =>
        ...
        private void SetupIsNameDuplicateNotDuplicate(string name, int id, int unitId, int departmentId)
        {
            _mockCommandRepo
                .Setup(r => r.IsNameDuplicateAsync(name, id, unitId, departmentId, It.IsAny<CancellationToken>()))
                .ReturnsAsync(false);
        }
        ...
        public async Task Validate_ValidCommand_PassesValidation()
        {
            ...
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 1, budgetTypeId: 10);
            SetupIsNameDuplicateNotDuplicate(command.Name, command.Id, command.UnitId, command.DepartmentId);
        ...
        {
            SetupMiscMasterDefaults();
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 0, budgetTypeId: 10);
            SetupIsNameDuplicateNotDuplicate(command.Name, 0, command.UnitId, command.DepartmentId);
        ...
        {
            SetupMiscMasterDefaults();
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 1, name: name, budgetTypeId: 10);
        ...
        {
            SetupMiscMasterDefaults();
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 1, unitId: 0, budgetTypeId: 10);
            SetupIsNameDuplicateNotDuplicate(command.Name, command.Id, 0, command.DepartmentId);
        ...
        {
            SetupMiscMasterDefaults();
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 1, departmentId: 0, budgetTypeId: 10);
            SetupIsNameDuplicateNotDuplicate(command.Name, command.Id, command.UnitId, 0);
        ...
        public async Task Validate_DuplicateName_FailsValidation()
        {
            ...
            _mockCommandRepo
                .Setup(r => r.IsNameDuplicateAsync(command.Name, command.Id, command.UnitId, command.DepartmentId, It.IsAny<CancellationToken>()))
                .ReturnsAsync(true);
        ...
        {
            SetupMiscMasterDefaults();
            var command = BudgetGroupBuilders.ValidUpdateCommand(id: 1, currencyId: 0, budgetTypeId: 10);
            SetupIsNameDuplicateNotDuplicate(command.Name, command.Id, command.UnitId, command.DepartmentId);
        ...
        {
            SetupMiscMasterDefaults();
            var command = new UpdateBudgetGroupCommand
            {
                Id = 1,
                Name = "Updated Group",
                UnitId = 1,
