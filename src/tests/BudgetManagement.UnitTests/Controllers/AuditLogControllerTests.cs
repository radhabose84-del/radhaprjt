...
namespace BudgetManagement.UnitTests.Controllers
{
    public sealed class AuditLogControllerTests
    {
        ...
        [Fact]
        public async Task GetAllAuditLogsAsync_CallsMediatorSend_Once()
        {
            _mockMediator
                .Setup(m => m.Send(It.IsAny<GetAuditLogQuery>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new List<AuditLogDto>());
        ...
        [Fact]
        public async Task GetAuditLog_WhenSuccess_ReturnsOkResult()
        {
            _mockMediator
        ...
        [Fact]
        public async Task GetAuditLog_WhenNotSuccess_ReturnsOkResultWithMessage()
        {
            _mockMediator
                .Setup(m => m.Send(It.IsAny<GetAuditLogBySearchPatternQuery>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new ApiResponseDTO<List<AuditLogDto>>
            ...
            var result = await CreateSut().GetAuditLog("nomatch");
