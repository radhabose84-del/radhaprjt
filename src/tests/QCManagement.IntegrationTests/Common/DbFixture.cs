...
namespace QCManagement.IntegrationTests.Common
{
    ...
    {
        private const string DbName = "QCManagement_TestDb";
...
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = 'QC')
    EXEC('CREATE SCHEMA QC');
");
        }
