namespace InventoryManagement.QATests.Tests.AuditLog;

// ─────────────────────────────────────────────────────────────────────────────
// AuditLog (Inventory) — live-server QA suite (READ-ONLY log report).
//
// Contract verified against source (2026-06-17 — AuditLogController.cs):
//   ⚠ Route prefix is "api/inventory/[controller]" → /api/inventory/AuditLog
//   GET /api/inventory/AuditLog                                  (list all — no params)
//   GET /api/inventory/AuditLog/GetAuditLogSearch?searchPattern= (search by free-text pattern)
//
...
[Collection("InvAuditLogCollection")]
[TestCaseOrderer("Shared.QAInfrastructure.Infrastructure.PriorityOrderer", "Shared.QAInfrastructure")]
public sealed class AuditLogQATests
{
    private readonly QAServerFixture _f;
    private const string BaseRoute = "/api/inventory/AuditLog";
