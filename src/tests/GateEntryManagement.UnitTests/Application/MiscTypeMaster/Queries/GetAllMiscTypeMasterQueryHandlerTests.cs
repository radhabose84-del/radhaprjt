...
namespace GateEntryManagement.UnitTests.Application.MiscTypeMaster.Queries
{
    public sealed class GetAllMiscTypeMasterQueryHandlerTests
    {
        ...
        public async Task Handle_ReturnsSuccess()
        {
            ...
            {
                new MiscTypeMasterDto { Id = 1, MiscTypeCode = "MT001", Description = "Test MiscType" }
            };
            _mockQueryRepo
            ...
            var result = await CreateSut().Handle(
                new GetAllMiscTypeMasterQuery { PageNumber = 1, PageSize = 10 },
        ...
        public async Task Handle_ReturnsPaginationMetadata()
        {
            var dtoList = new List<MiscTypeMasterDto>
            {
                new MiscTypeMasterDto { Id = 1, MiscTypeCode = "MT001", Description = "Test" }
            };
            _mockQueryRepo
            ...
            var result = await CreateSut().Handle(
                new GetAllMiscTypeMasterQuery { PageNumber = 2, PageSize = 5, SearchTerm = "search" },
                CancellationToken.None);
            ...
            _mockMediator.Verify(
                m => m.Publish(
                    It.Is<AuditLogsDomainEvent>(e =>
                        e.ActionDetail == "GetAllMiscTypeMasterQuery" &&
                        e.ActionCode == "Get"),
