...
namespace GateEntryManagement.UnitTests.Application.MiscMaster.Commands
{
    public sealed class DeleteMiscMasterCommandHandlerTests
    {
        ...
        public async Task Handle_ExistingId_ReturnsTrue()
        {
            ...
            var result = await sut.Handle(new DeleteMiscMasterCommand(1), CancellationToken.None);
        ...
        public async Task Handle_ExistingId_PublishesAuditEvent()
        {
            ...
            await sut.Handle(new DeleteMiscMasterCommand(1), CancellationToken.None);
        ...
        public async Task Handle_NonExistentId_DoesNotPublishAuditEvent()
        {
            ...
            var sut = CreateSut();
            try { await sut.Handle(new DeleteMiscMasterCommand(99), CancellationToken.None); }
            catch { /* expected */ }
