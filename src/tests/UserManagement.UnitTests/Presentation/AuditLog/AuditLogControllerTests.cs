...
namespace UserManagement.UnitTests.Presentation.AuditLog
{
    public sealed class AuditLogControllerTests
    {
        ...
        [Fact]
        public async Task GetAuditLog_Success_ReturnsOkResult()
        {
            _mockMediator
        ...
        [Fact]
        public async Task GetAuditLog_NotSuccess_ReturnsOkResult()
        {
            _mockMediator
                .Setup(m => m.Send(It.IsAny<GetAuditLogBySearchPatternQuery>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new ApiResponseDTO<List<AuditLogDto>>
        ...
        public async Task GetAuditLog_CallsMediatorSend_Once()
        {
            _mockMediator
                .Setup(m => m.Send(It.IsAny<GetAuditLogBySearchPatternQuery>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new ApiResponseDTO<List<AuditLogDto>> { IsSuccess = true, Data = new List<AuditLogDto>() });
