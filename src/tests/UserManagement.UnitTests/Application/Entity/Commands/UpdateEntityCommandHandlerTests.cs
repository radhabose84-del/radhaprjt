...
namespace UserManagement.UnitTests.Application.Entity.Commands
{
    public sealed class UpdateEntityCommandHandlerTests
    {
        ...
        private readonly Mock<ILogger<UpdateEntityCommandHandler>> _mockLogger = new(MockBehavior.Loose);
        private readonly Mock<IMediator> _mockMediator = new(MockBehavior.Loose);

        private UpdateEntityCommandHandler CreateSut() =>
        ...
        public async Task Handle_ValidCommand_ReturnsPositiveResult()
        {
            ...
            _mockCommandRepo
                .Setup(r => r.ExistsByNameupdateAsync("Updated", 1))
                .ReturnsAsync(false);

            _mockMapper
                .Setup(m => m.Map<UserManagement.Domain.Entities.Entity>(command))
                .Returns(new UserManagement.Domain.Entities.Entity());

            _mockCommandRepo
                .Setup(r => r.UpdateAsync(1, It.IsAny<UserManagement.Domain.Entities.Entity>()))
                .ReturnsAsync(1);
        ...
        public async Task Handle_NotFound_ThrowsValidationException()
        {
            ...
            Func<Task> act = () => CreateSut().Handle(
                new UpdateEntityCommand { Id = 999, EntityName = "Test" },
