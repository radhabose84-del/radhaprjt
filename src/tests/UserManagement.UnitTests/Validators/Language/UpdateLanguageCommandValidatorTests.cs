...
namespace UserManagement.UnitTests.Validators.Language
{
    ...
    {
        private UpdateLanguageCommandValidator CreateValidator()
        {
            ...
            return new UpdateLanguageCommandValidator(maxLenProvider);
        }
        ...
        {
            var command = LanguageBuilders.ValidUpdateCommand(name: name);
            var validator = CreateValidator();
        ...
        {
            var command = LanguageBuilders.ValidUpdateCommand(code: code);
            var validator = CreateValidator();
