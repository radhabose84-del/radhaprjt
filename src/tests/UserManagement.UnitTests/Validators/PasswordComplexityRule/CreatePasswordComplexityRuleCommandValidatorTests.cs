...
{
    public sealed class CreatePasswordComplexityRuleCommandValidatorTests
    {
        private static MaxLengthProvider CreateMaxLengthProvider()
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(databaseName: $"PwdComplexityCreateDb_{Guid.NewGuid()}")
                .Options;
        ...
        private static CreatePasswordComplexityRuleCommandValidator CreateValidator() =>
            new(CreateMaxLengthProvider());

        private static CreatePasswordComplexityRuleCommand ValidCommand() =>
            new CreatePasswordComplexityRuleCommand
            {
