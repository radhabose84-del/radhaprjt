...
// ─────────────────────────────────────────────────────────────────────────────
// US-WH-02 — Warehouse audit trail (read-only)
//   As a warehouse administrator I review the audit trail of warehouse actions.
// Route verified from WarehouseManagement.QATests: /api/warehouse/auditlog (raw list,
// status-only); search via GetAuditLogSearch?searchPattern=.
// ─────────────────────────────────────────────────────────────────────────────

[Collection("US-WH-02-AuditTrail")]
[Trait("Module", "WarehouseManagement")]
[Trait("Story", "US-WH-02")]
[Trait("Owner", "unassigned")]
[TestCaseOrderer("Shared.QAInfrastructure.Infrastructure.PriorityOrderer", "Shared.QAInfrastructure")]
public sealed class US_WH_02_AuditTrail_Tests
{
    private readonly QAServerFixture _f;
    private const string AuditRoute = "/api/warehouse/auditlog";

    public US_WH_02_AuditTrail_Tests(QAServerFixture fixture) => _f = fixture;

    // AC1 — all warehouse audit logs can be listed.
    [Fact, TestPriority(1)]
