...
namespace QCManagement.UnitTests.Application.MiscTypeMaster.Commands
{
    public class UpdateMiscTypeMasterCommandHandlerTests
    {
        ...
        private void SetupHappyPath(UpdateMiscTypeMasterCommand command, int updatedId = 1)
        {
            ...
            _mockMapper.Setup(m => m.Map<QCManagement.Domain.Entities.MiscTypeMaster>(command)).Returns(entity);
        ...
        public async Task Handle_ValidCommand_CallsUpdateAsync_Once()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.UpdateAsync(It.IsAny<QCManagement.Domain.Entities.MiscTypeMaster>()),
                Times.Once);
        }
        ...
        {
            var command = MiscTypeMasterBuilders.ValidUpdateCommand(id: 1, isActive: 0);
