...
namespace QCManagement.UnitTests.Application.AuditLog.Queries
{
    public sealed class GetAuditLogAutoCompleteQueryHandlerTests
    {
        ...
        private GetAuditLogAutoCompleteQueryHandler CreateSut()
        {
            _mockDatabase
                .Setup(d => d.GetCollection<AuditLogs>("AuditLogs", null))
                .Returns(_mockCollection.Object);

            return new GetAuditLogAutoCompleteQueryHandler(_mockDatabase.Object);
        }
        ...
        public void Constructor_InjectsMongoDatabase()
        {
            ...
            var sut = new GetAuditLogAutoCompleteQueryHandler(_mockDatabase.Object);
