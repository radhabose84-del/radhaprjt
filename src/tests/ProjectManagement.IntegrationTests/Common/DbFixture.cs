...
namespace ProjectManagement.IntegrationTests.Common
{
    ...
    public class DbFixture : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            await EnsureProjectSchemaAsync();
...
";
        ...
        private async Task EnsureProjectSchemaAsync()
        {
...
");
        ...
        /// <summary>
        /// Clears all tables in the Project schema by temporarily disabling FK constraints.
