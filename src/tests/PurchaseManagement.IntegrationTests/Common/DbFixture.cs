...
namespace PurchaseManagement.IntegrationTests.Common
{
    ...
    {
        private const string DbName = "PurchaseManagement_TestDb";
        ...
        private const string TestDbConnection =
            "Server=192.168.1.126;Database=PurchaseManagement_TestDb;User Id=developer;Password=Dev@#$456;Encrypt=False;TrustServerCertificate=True;MultipleActiveResultSets=true;";
        ...
        public async Task InitializeAsync()
        {
            ...
            await EnsurePurchaseSchemaAsync();
...
";
        ...
        private async Task EnsurePurchaseSchemaAsync()
        {
            await DbContext.Database.ExecuteSqlRawAsync(@"
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = 'Purchase')
