...
namespace PurchaseManagement.UnitTests.Validators.Quotation.RfqEntry
{
    public sealed class UpdateRfqValidatorTests
    {
        ...
        {
            var command = new UpdateRfqCommand { InitiationTypeId = 1 };
