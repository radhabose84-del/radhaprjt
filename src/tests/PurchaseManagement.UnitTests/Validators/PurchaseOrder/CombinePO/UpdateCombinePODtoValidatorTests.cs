...
{
    public sealed class UpdateCombinePODtoValidatorTests
    {
        private readonly Mock<IPoMethodLookup> _mockLookup = new(MockBehavior.Loose);

        private UpdateCombinePODtoValidator CreateValidator() => new(_mockLookup.Object);
        ...
        public async Task Validate_InvalidPOMethodId_FailsValidation()
        {
            ...
            var dto = new UpdateCombinePODto { POMethodId = 999 };
        ...
        public async Task Validate_BothPayloadsNull_FailsValidation()
        {
            ...
            var dto = new UpdateCombinePODto { POMethodId = 1, Local = null, Import = null };
