...
namespace PurchaseManagement.UnitTests.Application.Arrival.Commands
{
    public sealed class DeleteArrivalCommandHandlerTests
    {
        ...
        public async Task Handle_ExistingId_ReturnsTrue()
        {
            ...
            var result = await CreateSut().Handle(new DeleteArrivalCommand(1), CancellationToken.None);
        ...
        public async Task Handle_ExistingId_PublishesAuditEvent()
        {
            ...
            await CreateSut().Handle(new DeleteArrivalCommand(1), CancellationToken.None);
        ...
        public async Task Handle_NonExistentId_ThrowsExceptionRules()
        {
            ...
            Func<Task> act = async () => await CreateSut().Handle(new DeleteArrivalCommand(99), CancellationToken.None);
        ...
        public async Task Handle_NonExistentId_DoesNotPublishAuditEvent()
        {
            ...
            try { await CreateSut().Handle(new DeleteArrivalCommand(99), CancellationToken.None); }
            catch { /* expected */ }
