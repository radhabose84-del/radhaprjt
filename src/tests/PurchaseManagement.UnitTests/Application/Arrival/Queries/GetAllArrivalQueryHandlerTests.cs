...
namespace PurchaseManagement.UnitTests.Application.Arrival.Queries
{
    public sealed class GetAllArrivalQueryHandlerTests
    {
        ...
        public async Task Handle_ReturnsSuccess()
        {
            ...
            _mockQueryRepo.Setup(r => r.GetAllAsync(1, 10, null, null, null, null, null)).ReturnsAsync((list, 1));
        ...
        {
            var list = new List<ArrivalDto> { ArrivalBuilders.ValidDto() };
            _mockQueryRepo.Setup(r => r.GetAllAsync(2, 5, "ARV", null, null, null, null)).ReturnsAsync((list, 11));
        ...
        {
            _mockQueryRepo.Setup(r => r.GetAllAsync(1, 10, null, null, null, null, null)).ReturnsAsync((new List<ArrivalDto>(), 0));
        ...
        {
            var list = new List<ArrivalDto> { ArrivalBuilders.ValidDto() };
            _mockQueryRepo.Setup(r => r.GetAllAsync(1, 10, null, true, null, null, null)).ReturnsAsync((list, 1));
            ...
            result.IsSuccess.Should().BeTrue();
            result.Data.Should().HaveCount(1);
            _mockQueryRepo.Verify(r => r.GetAllAsync(1, 10, null, true, null, null, null), Times.Once);
        }
    }
}
