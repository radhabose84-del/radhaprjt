...
{
    public sealed class DeleteGRNEntryDocumentCommandHandlerTests
    {
        ...
        private DeleteGRNEntryDocumentCommandHandler CreateSut() =>
            new(_mockFileService.Object, _mockRepo.Object);

        [Fact]
        public async Task Handle_EmptyBaseDirectory_ThrowsException()
        {
            var command = new DeleteGRNEntryDocumentCommand { GrnEntrydocumentPath = "test.pdf" };
