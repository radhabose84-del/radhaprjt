...
{
    public sealed class DeleteGrnDetailDocumentCommandHandlerTests
    {
        ...
        private DeleteGrnDetailDocumentCommandHandler CreateSut() =>
            new(_mockFileService.Object, _mockRepo.Object);

        [Fact]
        public async Task Handle_EmptyBaseDirectory_ThrowsException()
        {
            var command = new DeleteGrnDetailDocumentCommand { GrnDetaildocumentPath = "line.png" };
