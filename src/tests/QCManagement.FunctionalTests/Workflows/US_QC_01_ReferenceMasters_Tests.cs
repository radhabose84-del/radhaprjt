...
// ─────────────────────────────────────────────────────────────────────────────
// US-QC-01 — QC reference master setup
//   As a QC administrator I define misc reference types/values used by quality parameters.
// Workflow: MiscTypeMaster → MiscMaster → read-back + deactivate-exclusion → teardown.
// Routes verified from QCManagement.QATests: /api/qc/misctypemaster, /api/qc/miscmaster;
// DELETE binds id from QUERY ?id=; by-name?term= (Misc also &MiscTypeCode=).
// ─────────────────────────────────────────────────────────────────────────────

[Collection("US-QC-01-ReferenceMasters")]
[Trait("Module", "QCManagement")]
[Trait("Story", "US-QC-01")]
[Trait("Owner", "unassigned")]
[TestCaseOrderer("Shared.QAInfrastructure.Infrastructure.PriorityOrderer", "Shared.QAInfrastructure")]
public sealed class US_QC_01_ReferenceMasters_Tests
{
    ...
    public US_QC_01_ReferenceMasters_Tests(QAServerFixture fixture) => _f = fixture;
