...
namespace FinanceManagement.IntegrationTests.Repositories.AuditLog
{
    /// <summary>
    /// AuditLogRepository wraps IMongoDbContext. Tests verify repo interactions
    /// against the abstraction without requiring a real MongoDB instance.
    /// </summary>
