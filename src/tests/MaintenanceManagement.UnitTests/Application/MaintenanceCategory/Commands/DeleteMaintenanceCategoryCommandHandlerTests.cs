...
{
    public sealed class DeleteMaintenanceCategoryCommandHandlerTests
    {
        ...
        private DeleteMaintenanceCategoryCommandHandler CreateSut() =>
        ...
        private void SetupHappyPath(int id = 1)
        {
            ...
            _mockCommandRepo
                .Setup(r => r.DeleteAsync(id, It.IsAny<MaintenanceManagement.Domain.Entities.MaintenanceCategory>()))
                .ReturnsAsync(id);
        ...
        public async Task Handle_ValidCommand_ReturnsId()
        {
            ...
            var result = await CreateSut().Handle(
                MaintenanceCategoryBuilders.ValidDeleteCommand(1), CancellationToken.None);
            result.Should().Be(1);
        }
        ...
        public async Task Handle_ValidCommand_CallsDeleteOnce()
        {
            ...
            _mockCommandRepo.Verify(
                r => r.DeleteAsync(1, It.IsAny<MaintenanceManagement.Domain.Entities.MaintenanceCategory>()),
                Times.Once);
        }
        ...
        public async Task Handle_DeleteReturnsMinusOne_ThrowsExceptionRules()
        {
            ...
            _mockCommandRepo
                .Setup(r => r.DeleteAsync(It.IsAny<int>(), It.IsAny<MaintenanceManagement.Domain.Entities.MaintenanceCategory>()))
                .ReturnsAsync(-1);

            Func<Task> act = async () => await CreateSut().Handle(
                MaintenanceCategoryBuilders.ValidDeleteCommand(), CancellationToken.None);
