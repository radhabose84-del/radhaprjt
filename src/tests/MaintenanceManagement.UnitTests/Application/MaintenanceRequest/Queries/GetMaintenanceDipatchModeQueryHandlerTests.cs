...
{
    public sealed class GetMaintenanceDipatchModeQueryHandlerBatchDTests
    {
        ...
        {
            _mockQueryRepo.Setup(r => r.GetMaintenanceDispatchModeDescAsync())
            ...
            var result = await CreateSut().Handle(new GetMaintenanceDispatchModeQuery(), CancellationToken.None);
