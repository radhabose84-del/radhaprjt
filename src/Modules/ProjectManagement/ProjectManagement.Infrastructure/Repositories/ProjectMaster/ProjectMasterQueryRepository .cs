...
//         public ProjectMasterQueryRepository(IDbConnection dbConnection, IIPAddressService iPAddressService, IDepartmentGrpcClient departmentGrpcClient, IMiscMasterQueryRepository miscMasterQueryRepository)
//         {
...
//         // public async Task<(IReadOnlyList<ProjectMasterDto> Items, int TotalCount)> GetProjectmasterAsync(
//         //     int pageNumber,
//         //     int pageSize,
//         //     string? searchTerm,
//         //     CancellationToken ct = default)
...
//         //     var projectMasters = (await multi.ReadAsync<ProjectMasterDto>()).ToList();
//         //     var totalCount = await multi.ReadFirstAsync<int>();

//         //     // 🔁 Load documents for the current page of projects
//         //     if (projectMasters.Count > 0)
//         //     {
//         //         var projectIds = projectMasters.Select(p => p.Id).ToArray();

//         //         const string docsSql = @" SELECT 
//         //             d.DocumentId,
//         //             mm.Code AS DocumentName,
//         //             d.FileName,
//         //             d.UploadedDate,        
...
//         //         JOIN Project.MiscMaster AS mm ON mm.Id = d.DocumentId
//         //         LEFT JOIN Project.MiscTypeMaster mtm ON mtm.MiscTypeCode = 'ImagePath'
//         //         LEFT JOIN Project.MiscTypeMaster mt ON mt.MiscTypeCode = 'ProjectImage'
...
//         //         //         d.FileName,
//         //         //         d.UploadedDate
//         //         //     FROM Project.ProjectDocument d
//         //         //     WHERE d.ProjectId IN @ProjectIds;";

//         //         // Local helper row type so we can capture ProjectId for grouping
//         //         var rows = await _dbConnection.QueryAsync<ProjectDocumentRow>(
//         //             new CommandDefinition(docsSql, new { ProjectIds = projectIds }, cancellationToken: ct));
...
//         //             .ToDictionary(
//         //                 g => g.Key,
//         //                 g => g.Select(r => new ProjectDocumentDto
//         //                 {
//         //                     Id = r.Id,
//         //                     DocumentId = r.DocumentId,
//         //                     FileName = r.FileName,
...
//         //         foreach (var pm in projectMasters)
//         //         {
//         //             if (docsByProject.TryGetValue(pm.Id, out var docs))
//         //                 pm.Documents = docs;
//         //             else
//         //                 pm.Documents = new List<ProjectDocumentDto>();
//         //         }
//         //     }
...
//         //     // ✅ Resolve StatusId from MiscMaster using (EntityName, Value)
//         //     int? statusId = null;

//         //     if (!string.IsNullOrWhiteSpace(searchTerm))
//         //     {
//         //         var misc = await _miscMasterQueryRepository.GetMiscMasterByName(
//         //             MiscEnumEntity.ApprovalStatus,        // ✅ entity/group name in MiscMaster
//         //             searchTerm.Trim()                  // ✅ value like "Approved", "Pending"
//         //         );

//         //         statusId = misc?.Id;

//         //         // If invalid status text -> return empty
//         //         if (statusId is null)
//         //             return new List<ProjectMasterAutoCompleteDto>();
//         //     }
...
//         //         @SearchTerm IS NULL
//         //         OR @SearchTerm = ''
//         //         OR ProjectCode LIKE '%' + @SearchTerm + '%'
//         //         OR ProjectName LIKE '%' + @SearchTerm + '%'
//         //         OR ProjectDescription LIKE '%' + @SearchTerm + '%'
//         //         OR StatusId IN (SELECT [value] FROM MiscMaster WITH (NOLOCK) WHERE [entity] = 'Approved' AND [value] LIKE '%' + @SearchTerm + '%')
//         //     )
//         // ORDER BY ProjectName;";
...
//         //         SELECT Id
//         //         FROM numbered
//         //         WHERE rn BETWEEN (@off + 1) AND (@off + @size);

//         //         SELECT
//         //             PM.Id                   AS Id,          -- IMPORTANT: alias as Id (NOT ProjectId)
//         //             PM.ProjectCode,
//         //             PM.ProjectName,
//         //             PM.ProjectDescription,
//         //             PM.ProjectTypeId,
...
//         //             PM.StatusId
//         //         FROM Project.ProjectMaster PM
//         //         WHERE PM.Id IN (SELECT Id FROM #paged)
//         //         ORDER BY PM.Id DESC;
...
//         //     using var multi = await _dbConnection.QueryMultipleAsync(new CommandDefinition(sql, param, cancellationToken: ct));
...
//         //             AND (
//         //                     @SearchTerm IS NULL OR @SearchTerm = '' OR
//         //                     PM.ProjectCode LIKE '%' + @SearchTerm + '%' OR
//         //                     PM.ProjectName LIKE '%' + @SearchTerm + '%'
//         //                 )
//         //         )
//         //         SELECT *
//         //         FROM Filtered
