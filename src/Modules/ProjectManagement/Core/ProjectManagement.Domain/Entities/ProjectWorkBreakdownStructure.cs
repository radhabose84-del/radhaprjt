...
{
    public class ProjectWorkBreakdownStructure : BaseEntity
    {
            public int ProjectId { get; set; }
            public ProjectMaster Project { get; set; } = default!;
             public int? ParentWorkBreakdownStructureId { get; set; }
            public ProjectWorkBreakdownStructure? ParentWorkBreakdownStructure { get; set; }
            public ICollection<ProjectWorkBreakdownStructure>? ChildWorkBreakdownStructures { get; set; }  = new List<ProjectWorkBreakdownStructure>();
