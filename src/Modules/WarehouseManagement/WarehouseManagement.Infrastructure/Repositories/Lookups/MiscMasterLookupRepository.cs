...
namespace WarehouseManagement.Infrastructure.Repositories.Lookups
{
    internal class MiscMasterLookupRepository : IMiscMasterLookup
    {
        ...
        public async Task<(int? WarehouseTypeId, int? StorageTypeId, int? AreaTypeId, int? OperationTypeId, int? FloorTypeId, int? AisleTypeId, int? RackLevelTypeId)> GetMiscTypeIdsAsync()
        {
            ...
            {
                WarehouseType = MiscEnumEntity.MiscTypes.WarehouseType,
                StorageType = MiscEnumEntity.MiscTypes.StorageType,
                AreaType = MiscEnumEntity.MiscTypes.AreaType,
                OperationType = MiscEnumEntity.MiscTypes.OperationType,
                FloorType = MiscEnumEntity.MiscTypes.Floor,
                AisleType = MiscEnumEntity.MiscTypes.WarehouseAisle,
                RackLevelType = MiscEnumEntity.MiscTypes.WarehouseRackLevel
            });
