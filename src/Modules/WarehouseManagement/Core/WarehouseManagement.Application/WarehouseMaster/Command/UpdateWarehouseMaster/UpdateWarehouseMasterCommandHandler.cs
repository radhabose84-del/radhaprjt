...
//         public UpdateWarehouseMasterCommandHandler(IWarehouseMasterCommandRepository warehouseMasterCommandRepository, IWarehouseMasterQueryRepository warehouseMasterQueryRepository, IWarehouseCodeGenerator warehouseCodeGenerator, IMapper mapper, IMediator mediator, ILocationGrpcClient locationGrpcClient)
//         {
...
//                 if (ids is null)
//                     return new ApiResponseDTO<bool> { IsSuccess = false, Message = "Unable to resolve City/State/Country." };
