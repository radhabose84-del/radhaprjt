...
namespace PartyManagement.Presentation.Validation.PartyMaster
{
    public class CreatePartyMasterCommandValidator : AbstractValidator<CreatePartyMasterCommand>
    {
        ...
        , IBankAccountLookup bankAccountLookup)
        {
            ...
            RuleFor(x => x.PartyMaster.BankAccountId)
                ...
                .When(x => x.PartyMaster.BankAccountId > 0);

            // ------------------- Party-type mutual exclusivity -------------------
            // A party cannot be both Agent and Broker, nor both Supplier and Ginner.
            RuleFor(x => x.PartyMaster.PartyTypes)
                ...
                .When(x => x.PartyMaster.PartyTypes != null && x.PartyMaster.PartyTypes.Count > 0);
        ...
        private async Task<IReadOnlyList<string>> ResolvePartyTypeCodesAsync(List<CreatePartyMasterDto.PartyTypeDto> partyTypes)
        {
