...
namespace PartyManagement.Presentation.Validation.MiscMaster
{
    public class CreateMiscMasterCommandValidator : AbstractValidator<CreateMiscMasterCommand>
    {
         ...
         public CreateMiscMasterCommandValidator( IMiscMasterQueryRepository miscMasterQuery,MaxLengthProvider maxLengthProvider)
        {
            ...
            var MiscCodeMaxLength = maxLengthProvider.GetMaxLength<PartyManagement.Domain.Entities.MiscMaster>("Code") ?? 50;
            var DescriptionMaxLength = maxLengthProvider.GetMaxLength<PartyManagement.Domain.Entities.MiscMaster>("Description")?? 250;
