...
namespace PartyManagement.Infrastructure.Migrations
{
    ...
    [Migration("20251110092423_bankaccountholdername")]
    partial class bankaccountholdername
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.BankMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.PartyUnitCompanyMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.MiscMaster", "BankAccountMisc")
            ...
            modelBuilder.Entity("Core.Domain.Entities.PartyMaster", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.MiscMaster", "StatusParty")
            ...
            modelBuilder.Entity("Core.Domain.Entities.PartyUnitCompanyMapping", b =>
                {
                    b.HasOne("Core.Domain.Entities.PartyMaster", "PartyUnitCompany")
