...
{
    /// <inheritdoc />
    public partial class AgentConfig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentPayableControlGl = table.Column<string>(type: "nvarchar(10)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentConfig_MiscMaster_SettlementCycleId",
                    ...
                    table.ForeignKey(
                        name: "FK_AgentConfig_PartyMaster_PartyId",
                        column: x => x.PartyId,
                        principalSchema: "Party",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentConfig_PartyId",
                schema: "Party",
                table: "AgentConfig",
                column: "PartyId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentConfig_SettlementCycleId",
                schema: "Party",
                table: "AgentConfig",
