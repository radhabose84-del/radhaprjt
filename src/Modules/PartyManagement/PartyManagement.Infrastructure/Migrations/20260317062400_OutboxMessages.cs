        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "PartyManagement"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Party_OutboxMessages_CorrelationId",
                schema: "Party",
                table: "OutboxMessages",
                column: "CorrelationId");

            migrationBuilder.CreateIndex(
                name: "IX_Party_OutboxMessages_CreatedAt",
                schema: "Party",
                table: "OutboxMessages",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Party_OutboxMessages_Status_NextRetryAt",
                schema: "Party",
                table: "OutboxMessages",
