...
using PurchaseManagement.API.Validation.PaymentTermMaster;
using PurchaseManagement.API.Validation.Quotation;
using PurchaseManagement.API.Validation.TnCTemplateMaster;
using PurchaseManagement.API.Validation.Quotation.RfqEntry;
using PurchaseManagement.API.Validation.PurchaseIndent;
...
using PurchaseManagement.API.Validation.Quotation.QuotationCompare;
...
using PurchaseManagement.API.Validation.GRN.GateEntry;
using PurchaseManagement.Application.GRN.GRNEntry.Commands;
using PurchaseManagement.API.Validation.GRN.GRNEntry;
...
using PurchaseManagement.API.Validation.ServiceMaster;
...
using PurchaseManagement.API.Validation.MRS;
...
using PurchaseManagement.API.Validation.Issue;
using PurchaseManagement.Application.PurchaseOrder.ServicePO.Command.Create;
using PurchaseManagement.API.Validation.PurchaseOrder.ServicePo;
using PurchaseManagement.Application.PurchaseOrder.Dtos.ServicePO;
using PurchaseManagement.API.Validation.ExchangeRate;
using PurchaseManagement.Application.ExchangeRate.Queries;
...
using PurchaseManagement.API.Validation.PurchaseOrder.BillEntry;
...
using PurchaseManagement.API.Validation.IssueReturn;
