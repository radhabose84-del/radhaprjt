...
//         public GetServiceAutocompleteQueryHandler(IServiceQueryRepository serviceQueryRepository, IMapper mapper, IMediator mediator, IHSNGrpcClient hSNGrpcClient, IUOMGrpcClient uOMGrpcClient)
//         {
...
//             var uomsTask = _uOMGrpcClient.GetUOMAsync();              // List<UomDto> (Id, Code, UOMName)
//             var hsnsTask = _hSNGrpcClient.GetAllAsync(1, 1000, null); // (List<HsnDto> Items, int Total)
