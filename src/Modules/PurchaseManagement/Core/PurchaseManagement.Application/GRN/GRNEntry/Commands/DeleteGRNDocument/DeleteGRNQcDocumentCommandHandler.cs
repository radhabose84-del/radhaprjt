...
{
    public class DeleteGRNQcDocumentCommandHandler : IRequestHandler<DeleteGRNQcDocumentCommand, bool>
    {
        private readonly IFileUploadService _fileUploadService;
        private readonly IGRNEntryQueryRepository _iGrnEntryQueryRepository;

        public DeleteGRNQcDocumentCommandHandler(IFileUploadService fileUploadService, IGRNEntryQueryRepository iGrnEntryQueryRepository)
        {
            _fileUploadService = fileUploadService;
            _iGrnEntryQueryRepository = iGrnEntryQueryRepository;
        }

        public async Task<bool> Handle(DeleteGRNQcDocumentCommand request, CancellationToken cancellationToken)
        {
            ...
            string filePath = Path.Combine(uploadPath, request.GrnQcdocumentPath ?? string.Empty);
