...
public sealed class GetAllContractPOQueryHandler
    : IRequestHandler<GetAllContractPOQuery, PagedResult<ContractPOHeaderDto>>
{
    ...
    public GetAllContractPOQueryHandler(
    ...
    public async Task<PagedResult<ContractPOHeaderDto>> Handle(
        GetAllContractPOQuery request, CancellationToken ct)
    {
        ...
        var ev = new AuditLogsDomainEvent(
            actionDetail: "GetAllContractPOQuery",
            actionCode: "Get",
