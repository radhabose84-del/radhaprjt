...
public sealed class ImportPODetailDto
{
    ...
    public bool GRBasedIV { get; set; } // maps to GR-BasedIV
}

public sealed class ImportPOHeaderDto
{
    public int? Id { get; set; }
    ...
    public List<ImportPODetailDto> Details { get; set; } = new();
}

public sealed class ImportPurchasePaymentTermDto
{
    public int? Id { get; set; }
    public int PurchaseOrderId { get; set; }
...
public class ImportPOCreateDto
{
    ...
    // Children
    public List<ImportPOHeaderDto> Headers { get; set; } = new();
    public List<ImportPurchasePaymentTermDto> PaymentTerms { get; set; } = new();
...
public class ImportPOUpdateDto : ImportPOCreateDto { public new int Id { get; set; } }

// List/Detail view models (for queries)
public sealed class ImportPOListItemDto
{
    public int Id { get; set; }
    public string PONumber { get; set; } = default!;
    public DateTimeOffset PODate { get; set; }
