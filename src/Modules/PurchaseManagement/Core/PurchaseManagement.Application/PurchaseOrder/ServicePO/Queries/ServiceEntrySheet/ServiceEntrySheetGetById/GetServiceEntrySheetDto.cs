...
{
    public class GetServiceEntrySheetDto
    {
        ...
        public int StatusId { get; set; }   // workflow status from Misc (Pending/Approved/Rejected etc.)

        public List<ServiceEntryActivityDto> Activities { get; set; } = new();
