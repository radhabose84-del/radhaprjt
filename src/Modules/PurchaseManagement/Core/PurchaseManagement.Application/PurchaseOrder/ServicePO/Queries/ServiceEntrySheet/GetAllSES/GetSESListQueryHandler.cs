...
//         public GetSESListQueryHandler(IServicePurchaseOrderQueryRepository servicePurchaseOrderQueryRepository, IMapper mapper, IMediator mediator, IUnitGrpcClient unitGrpcClient, IPartyGrpcClient partyGrpcClient
...
//             {
//                 var party = await _partyGrpcClient.GetPartyByIdAsync(vendorId);
//                 if (party != null)
//                 {
//                     vendorLookup[vendorId] = (party.PartyName, party.PartyCode);
//                 }
//             }
