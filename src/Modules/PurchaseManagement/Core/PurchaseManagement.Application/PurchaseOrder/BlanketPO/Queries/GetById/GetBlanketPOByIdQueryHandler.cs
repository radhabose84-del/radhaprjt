...
public sealed class GetBlanketPOByIdQueryHandler
    : IRequestHandler<GetBlanketPOByIdQuery, BlanketPODetailVm?>
{
    ...
    public GetBlanketPOByIdQueryHandler(
    ...
    public async Task<BlanketPODetailVm?> Handle(
        GetBlanketPOByIdQuery request, CancellationToken ct)
    {
        var dto = await _repo.GetBlanketPOByIdAsync(request.Id, ct);
        ...
        var ev = new AuditLogsDomainEvent(
            ...
            actionCode: "GetBlanketPOByIdQuery",
            actionName: dto.Id.ToString(),
            details: $"Blanket Release PO details {dto.Id} was fetched.",
            module: "BlanketPO"
        );
