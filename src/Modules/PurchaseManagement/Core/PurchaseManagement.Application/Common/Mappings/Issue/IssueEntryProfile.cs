...
using static PurchaseManagement.Application.Issue.Command.CreateIssueEntry.CreateIssueEntryDto;

namespace PurchaseManagement.Application.Common.Mappings.Issue
{
