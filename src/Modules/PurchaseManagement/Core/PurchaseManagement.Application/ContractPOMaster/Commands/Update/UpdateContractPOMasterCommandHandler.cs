...
public sealed class UpdateContractPOMasterCommandHandler
    : IRequestHandler<UpdateContractPOMasterCommand, ContractPOHeaderDto>
{
    ...
    public UpdateContractPOMasterCommandHandler(
    ...
    public async Task<ContractPOHeaderDto> Handle(
        UpdateContractPOMasterCommand request, CancellationToken ct)
    {
