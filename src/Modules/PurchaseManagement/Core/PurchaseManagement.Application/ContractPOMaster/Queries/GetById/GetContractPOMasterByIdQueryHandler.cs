...
public sealed class GetContractPOMasterByIdQueryHandler
    : IRequestHandler<GetContractPOMasterByIdQuery, ContractPOHeaderDto?>
{
    ...
    public GetContractPOMasterByIdQueryHandler(
    ...
    public async Task<ContractPOHeaderDto?> Handle(
        GetContractPOMasterByIdQuery request, CancellationToken ct)
    {
        ...
        var ev = new AuditLogsDomainEvent(
            ...
            actionCode: "GetContractPOMasterByIdQuery",
            actionName: dto.Id.ToString(),
            details: $"Contract PO details {dto.Id} was fetched.",
            module: "ContractPO"
        );
