...
public sealed class ImportPoAmendmentCommandValidator : AbstractValidator<ImportPOAmendmentCommand>
{
    private readonly IImportPOQueryRepository _q;

    public ImportPoAmendmentCommandValidator(IImportPOQueryRepository q)
    {
        _q = q;
