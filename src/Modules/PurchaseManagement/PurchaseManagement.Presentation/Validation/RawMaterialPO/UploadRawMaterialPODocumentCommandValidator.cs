...
public class UploadRawMaterialPODocumentCommandValidator : AbstractValidator<UploadRawMaterialPODocumentCommand>
{
    private const long MaxFileSize = 5L * 1024 * 1024;

    private readonly List<ValidationRule> _validationRules;

    public UploadRawMaterialPODocumentCommandValidator()
    {
