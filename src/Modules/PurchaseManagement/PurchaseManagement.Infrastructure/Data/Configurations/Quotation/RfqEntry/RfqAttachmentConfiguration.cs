...
public class RfqAttachmentConfiguration : IEntityTypeConfiguration<RfqAttachment>
{
    public void Configure(EntityTypeBuilder<RfqAttachment> b)
    {
        ...
        b.Property(x => x.RfqId).HasColumnType("int").IsRequired();

        b.Property(x => x.FileName).HasColumnType("nvarchar(260)").IsRequired();
        b.Property(x => x.OriginalFileName).HasColumnType("nvarchar(260)").IsRequired();
        b.Property(x => x.FilePath).HasColumnType("nvarchar(500)").IsRequired();
        b.Property(x => x.FileType).HasColumnType("nvarchar(100)").IsRequired(false);
        b.Property(x => x.FileSize).HasColumnType("bigint").IsRequired();
