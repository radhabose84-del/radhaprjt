...
namespace PurchaseManagement.Infrastructure.Data.Configurations.GRN.GRNEntry.StockLedger
{
    public class StockLedgerDetailConfiguration : IEntityTypeConfiguration<PurchaseManagement.Domain.Entities.GRN.StockLedger.StockLedger>
    {
        public void Configure(EntityTypeBuilder<PurchaseManagement.Domain.Entities.GRN.StockLedger.StockLedger> builder)
        {
            builder.ToTable("StockLedger", "Purchase");
            // Primary Key
