...
namespace PurchaseManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250913122428_QuotationFinal")]
    partial class QuotationFinal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurchaseManagement.Domain.Entities.Quotation.QuotationFinal.QuotationConfirmedDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("FreightPerItem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0.00m);
                    ...
                    b.Property<int>("QuotationConfirmedHeaderId")
                        .HasColumnType("int")
                        .HasColumnName("QuotationConfirmedHeaderId");
                    ...
                    b.HasIndex("QuotationConfirmedHeaderId");

                    b.HasIndex("QuotationDetailId");

                    b.HasIndex("QuotationHeaderId");

                    b.ToTable("QuotationConfirmedDetail", "Purchase");
                });

            modelBuilder.Entity("PurchaseManagement.Domain.Entities.Quotation.QuotationFinal.QuotationConfirmedHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("QuotationConfirmedHeader", "Purchase");
                });
            ...
            modelBuilder.Entity("PurchaseManagement.Domain.Entities.Quotation.QuotationFinal.QuotationConfirmedDetail", b =>
                {
                    b.HasOne("PurchaseManagement.Domain.Entities.Quotation.QuotationFinal.QuotationConfirmedHeader", "QuotationConfirmedHeader")
                        .WithMany("QuotationConfirmedDetails")
                        .HasForeignKey("QuotationConfirmedHeaderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PurchaseManagement.Domain.Entities.Quotation.QuotationEntry.QuotationDetail", "QuotationDetail")
                        .WithMany("ConfirmedDetailLines")
                    ...
                    b.Navigation("QuotationConfirmedHeader");
            ...
            modelBuilder.Entity("PurchaseManagement.Domain.Entities.Quotation.QuotationEntry.QuotationDetail", b =>
                {
                    b.Navigation("ConfirmedDetailLines");
                });
