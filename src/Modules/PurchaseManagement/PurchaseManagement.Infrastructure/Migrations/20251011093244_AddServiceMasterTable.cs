...
{
    /// <inheritdoc />
    public partial class AddServiceMasterTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceCode = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ServiceDescription = table.Column<string>(type: "nvarchar(200)", nullable: false),
