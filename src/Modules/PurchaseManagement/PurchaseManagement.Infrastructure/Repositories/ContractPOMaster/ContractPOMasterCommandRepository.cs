...
public sealed class ContractPOMasterCommandRepository : IContractPOMasterCommandRepository
{
    private readonly ApplicationDbContext _db;
    private readonly IIPAddressService _ipAddressService;
    private readonly IDocumentSequenceLookup _documentSequenceLookup;

    public ContractPOMasterCommandRepository(
    ...
    public async Task<bool> UpdateContractPOApproveAsync(int id, int statusId, CancellationToken ct)
    {
        var existing = await _db.Set<ContractPOHeader>()
            .FirstOrDefaultAsync(x => x.Id == id && x.IsDeleted == IsDelete.NotDeleted, ct);
