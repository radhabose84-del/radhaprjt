...
namespace PurchaseManagement.Infrastructure.Repositories.Outbox
{
    public class OutboxRepository : IOutboxRepository
    {
        ...
        public async Task AddAsync(OutboxMessage message, CancellationToken cancellationToken = default)
        {
            ...
            // Save immediately - use when caller doesn't manage transaction
        ...
        public async Task AddWithoutSaveAsync(OutboxMessage message, CancellationToken cancellationToken = default)
        {
            ...
            // This allows outbox message to participate in the same transaction as other operations
        }
