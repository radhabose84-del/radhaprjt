...
namespace PurchaseManagement.Infrastructure.Repositories.MiscTypeMaster
{
    public class MiscTypeMasterCommandRepository  : IMiscTypeMasterCommandRepository
    {
     ...
     public async   Task<PurchaseManagement.Domain.Entities.MiscTypeMaster> CreateAsync(PurchaseManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
          ...
          public async Task<bool> UpdateAsync(int id,PurchaseManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id,PurchaseManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
