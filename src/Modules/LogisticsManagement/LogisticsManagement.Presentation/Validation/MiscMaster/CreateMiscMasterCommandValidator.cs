...
namespace LogisticsManagement.Presentation.Validation.MiscMaster
{
    public class CreateMiscMasterCommandValidator : AbstractValidator<CreateMiscMasterCommand>
    {
            ...
            IMiscMasterQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<LogisticsManagement.Domain.Entities.MiscMaster>("Code") ?? 20;
            var maxLengthDescription = maxLengthProvider.GetMaxLength<LogisticsManagement.Domain.Entities.MiscMaster>("Description") ?? 250;
