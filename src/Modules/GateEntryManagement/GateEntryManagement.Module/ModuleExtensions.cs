...
namespace GateEntryManagement.Module
{
    public static class ModuleExtensions
    {
        public static IServiceCollection AddGateEntryManagementModule(
            this IServiceCollection services,
            IConfiguration configuration,
            IHostEnvironment env)
        {
            // ✅ 0) Infrastructure FIRST (DbContext + repos + services)
            services.AddGateEntryInfrastructureServices(configuration, env);
