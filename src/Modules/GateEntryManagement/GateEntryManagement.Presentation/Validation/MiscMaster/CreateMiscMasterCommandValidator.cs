...
namespace GateEntryManagement.Presentation.Validation.MiscMaster
{
    public class CreateMiscMasterCommandValidator : AbstractValidator<CreateMiscMasterCommand>
    {
            ...
            IMiscMasterQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<GateEntryManagement.Domain.Entities.MiscMaster>("Code") ?? 20;
            var maxLengthDescription = maxLengthProvider.GetMaxLength<GateEntryManagement.Domain.Entities.MiscMaster>("Description") ?? 250;
