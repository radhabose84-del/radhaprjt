...
namespace GateEntryManagement.Presentation.Validation.MiscTypeMaster
{
    public class CreateMiscTypeMasterCommandValidator : AbstractValidator<CreateMiscTypeMasterCommand>
    {
            ...
            IMiscTypeMasterQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<GateEntryManagement.Domain.Entities.MiscTypeMaster>("MiscTypeCode") ?? 20;
            var maxLengthDescription = maxLengthProvider.GetMaxLength<GateEntryManagement.Domain.Entities.MiscTypeMaster>("Description") ?? 250;
