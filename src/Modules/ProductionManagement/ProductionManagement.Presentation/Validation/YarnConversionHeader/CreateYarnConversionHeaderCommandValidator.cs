                ...
                switch (rule.Rule)
                {
                    ...
                    case "DateCompare":
                        RuleFor(x => x.OldEndPackNo)
                            ...
                            .WithMessage($"{nameof(CreateYarnConversionHeaderCommand.OldEndPackNo)} must be greater than or equal to {nameof(CreateYarnConversionHeaderCommand.OldStartPackNo)}.");
                        break;
