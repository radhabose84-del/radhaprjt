...
{
    public class CountGroupConfiguration : IEntityTypeConfiguration<CountGroup>
    {
        public void Configure(EntityTypeBuilder<CountGroup> builder)
        {
            ...
            builder.ToTable("CountGroup", "Production");
            builder.HasKey(t => t.Id);

            builder.Property(t => t.CountGroupCode)
                .HasColumnType("varchar(20)")
                .IsRequired();

            builder.Property(t => t.CountGroupName)
            ...
            builder.HasIndex(t => t.CountGroupCode).IsUnique();
            builder.HasIndex(t => t.CountGroupName).IsUnique();
        }
    }
}
