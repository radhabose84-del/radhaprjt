...
namespace ProductionManagement.Infrastructure.Data.Configurations
{
    ...
    {
        public void Configure(EntityTypeBuilder<CertificationMaster> builder)
        {
            ...
            builder.ToTable("CertificationMaster", "Production");
            ...
            builder.HasIndex(t => t.CertificationName).IsUnique();
        }
    }
}
