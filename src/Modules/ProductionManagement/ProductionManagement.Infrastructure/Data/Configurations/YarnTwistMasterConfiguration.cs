...
{
    public class YarnTwistMasterConfiguration : IEntityTypeConfiguration<YarnTwistMaster>
    {
        public void Configure(EntityTypeBuilder<YarnTwistMaster> builder)
        {
            ...
            builder.ToTable("YarnTwistMaster", "Production");
            builder.HasKey(t => t.Id);

            builder.Property(t => t.TwistName)
            ...
            builder.HasIndex(t => t.TwistName).IsUnique();
        }
    }
}
