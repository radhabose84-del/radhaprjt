...
{
    public class DeleteYarnConversionHeaderCommandHandler : IRequestHandler<DeleteYarnConversionHeaderCommand, bool>
    {
        ...
        public async Task<bool> Handle(DeleteYarnConversionHeaderCommand request, CancellationToken cancellationToken)
        {
