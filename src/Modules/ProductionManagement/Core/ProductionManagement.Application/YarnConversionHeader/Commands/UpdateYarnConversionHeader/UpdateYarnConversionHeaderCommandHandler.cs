...
{
    public class UpdateYarnConversionHeaderCommandHandler
        : IRequestHandler<UpdateYarnConversionHeaderCommand, ApiResponseDTO<int>>
    {
        ...
        public async Task<ApiResponseDTO<int>> Handle(
            UpdateYarnConversionHeaderCommand request,
