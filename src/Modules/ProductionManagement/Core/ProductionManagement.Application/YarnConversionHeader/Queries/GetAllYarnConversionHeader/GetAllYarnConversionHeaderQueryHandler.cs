...
{
    public class GetAllYarnConversionHeaderQueryHandler : IRequestHandler<GetAllYarnConversionHeaderQuery, ApiResponseDTO<List<YarnConversionHeaderDto>>>
    {
        ...
        public async Task<ApiResponseDTO<List<YarnConversionHeaderDto>>> Handle(GetAllYarnConversionHeaderQuery request, CancellationToken cancellationToken)
        {
