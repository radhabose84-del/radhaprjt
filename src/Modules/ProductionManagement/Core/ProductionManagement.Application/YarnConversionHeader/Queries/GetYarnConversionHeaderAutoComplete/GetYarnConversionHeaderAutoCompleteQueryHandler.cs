...
{
    public class GetYarnConversionHeaderAutoCompleteQueryHandler : IRequestHandler<GetYarnConversionHeaderAutoCompleteQuery, List<YarnConversionHeaderLookupDto>>
    {
        ...
        public async Task<List<YarnConversionHeaderLookupDto>> Handle(GetYarnConversionHeaderAutoCompleteQuery request, CancellationToken cancellationToken)
        {
            ...
            var domainEvent = new AuditLogsDomainEvent(
                ...
                details: "YarnConversionHeader details was fetched.",
