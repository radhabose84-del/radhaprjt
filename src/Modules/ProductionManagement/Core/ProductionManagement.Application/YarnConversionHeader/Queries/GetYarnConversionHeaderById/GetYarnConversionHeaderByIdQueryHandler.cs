...
{
    public class GetYarnConversionHeaderByIdQueryHandler : IRequestHandler<GetYarnConversionHeaderByIdQuery, YarnConversionHeaderDto?>
    {
        ...
        public async Task<YarnConversionHeaderDto?> Handle(GetYarnConversionHeaderByIdQuery request, CancellationToken cancellationToken)
        {
