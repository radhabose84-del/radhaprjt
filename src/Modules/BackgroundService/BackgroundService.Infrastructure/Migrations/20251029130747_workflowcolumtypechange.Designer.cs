...
namespace BackgroundService.Infrastructure.Migrations
{
    ...
    [Migration("20251029130747_workflowcolumtypechange")]
    partial class workflowcolumtypechange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalRuleCondition", b =>
                {
                    ...
                    b.Property<int>("RightValueId")
                        .HasColumnType("int")
                        .HasColumnName("RightValueId");
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalRuleCondition", b =>
                {
                    ...
                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "RightValue")
                        .WithMany("RightValue")
                        .HasForeignKey("RightValueId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
