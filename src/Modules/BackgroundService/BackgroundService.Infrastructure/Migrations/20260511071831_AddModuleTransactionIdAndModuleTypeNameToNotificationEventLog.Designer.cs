...
namespace BackgroundService.Infrastructure.Migrations
{
    ...
    [Migration("20260511071831_AddModuleTransactionIdAndModuleTypeNameToNotificationEventLog")]
    partial class AddModuleTransactionIdAndModuleTypeNameToNotificationEventLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackgroundService.Core.Domain.Entities.Notifications.NotificationWhatsAppGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NotificationWhatsAppGroup", "AppNotification");
                });
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalDataField", b =>
                {
                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "Scope")
                        .WithMany("Scope")
                        .HasForeignKey("ScopeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "ValueType")
                        .WithMany("ValueType")
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalRequest", b =>
                {
                    ...
                    b.HasOne("BackgroundService.Domain.Entities.Workflow.WorkflowType", "WType")
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalRule", b =>
                {
                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "Action")
                        .WithMany("Action")
                    ...
                    b.HasOne("BackgroundService.Domain.Entities.Workflow.WorkflowType", null)
                        .WithMany("ApprovalRules")
                        .HasForeignKey("WorkflowTypeId");
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Workflow.ApprovalRuleCondition", b =>
                {
                    ...
                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "Operator")
                        .WithMany("Operator")
                        .HasForeignKey("OperatorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BackgroundService.Domain.Entities.Notification.MiscMaster", "RightType")
                        .WithMany("RightType")
            ...
            modelBuilder.Entity("BackgroundService.Domain.Entities.Notification.MiscMaster", b =>
                {
                    ...
                    b.Navigation("ApprovalTargetType");
