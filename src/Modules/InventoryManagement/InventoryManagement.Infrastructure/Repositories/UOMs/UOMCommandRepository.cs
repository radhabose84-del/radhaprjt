...
namespace InventoryManagement.Infrastructure.Repositories.UOMs
{
    public class UOMCommandRepository : IUOMCommandRepository
    {
        ...
        public async Task<bool  > CheckForDuplicatesAsync(string name, int sortOrder, int excludeId)
        {
        ...
        public async Task<InventoryManagement.Domain.Entities.UOM> CreateAsync(InventoryManagement.Domain.Entities.UOM uom)
        {
