...
namespace InventoryManagement.Infrastructure.Repositories.MiscMaster
{
    public class MiscMasterCommandRepository  : IMiscMasterCommandRepository
  {
        ...
        public async Task<InventoryManagement.Domain.Entities.MiscMaster> CreateAsync(InventoryManagement.Domain.Entities.MiscMaster miscMaster)
        {
        ...
        public async Task<bool> UpdateAsync(int id, InventoryManagement.Domain.Entities.MiscMaster miscMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id, InventoryManagement.Domain.Entities.MiscMaster miscMaster)
        {
