...
namespace InventoryManagement.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInventoryInfrastructure(this IServiceCollection services, IConfiguration configuration, IHostEnvironment env)
        {
            ...
            services.AddScoped<IItemSpecificationMasterCommandRepository, ItemSpecificationMasterCommandRepository>();
            services.AddScoped<IItemSpecificationMasterQueryRepository, ItemSpecificationMasterQueryRepository>();
            services.AddScoped<IItemSpecificationValueCommandRepository, ItemSpecificationValueCommandRepository>();
            services.AddScoped<IItemSpecificationValueQueryRepository, ItemSpecificationValueQueryRepository>();
