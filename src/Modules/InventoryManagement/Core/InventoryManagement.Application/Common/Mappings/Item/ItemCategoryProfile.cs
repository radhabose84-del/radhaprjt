    ...
    public class ItemCategoryProfile : Profile
    {
        public ItemCategoryProfile()
        {
            ...
            CreateMap<CreateItemCategoryCommand, InventoryManagement.Domain.Entities.Item.ItemCategory>()
                ...
                .ForMember(dest => dest.EmergencyPOById, opt => opt.MapFrom(src => src.EmergencyPOById))
                .ForMember(dest => dest.EmergencyValueLimit, opt => opt.MapFrom(src => src.EmergencyValueLimit))
                .ForMember(dest => dest.EmergencyActionId, opt => opt.MapFrom(src => src.EmergencyActionId))
