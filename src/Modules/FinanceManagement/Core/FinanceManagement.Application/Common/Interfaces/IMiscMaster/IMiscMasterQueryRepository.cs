...
namespace FinanceManagement.Application.Common.Interfaces.IMiscMaster
{
    public interface IMiscMasterQueryRepository
    {
        ...
        Task<FinanceManagement.Domain.Entities.MiscMaster?> GetMiscMasterByName(string miscTypeCode, string miscTypeName);
        Task<FinanceManagement.Domain.Entities.MiscMaster?> GetMiscMasterByCode(string code);
    }
}
