...
namespace FinanceManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260617064259_GstrSectionMasterAndLinkage")]
    partial class GstrSectionMasterAndLinkage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.TaxAccountLinkage", b =>
                {
                    ...
                    b.Property<int?>("OldControlAccountId")
                        .HasColumnType("int")
                        .HasColumnName("OldControlAccountId");

                    b.Property<int?>("OldTaxCodeId")
                        .HasColumnType("int")
                        .HasColumnName("OldTaxCodeId");
                    ...
                    b.HasIndex("OldControlAccountId");

                    b.HasIndex("OldTaxCodeId");
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.TaxAccountLinkage", b =>
                {
                    ...
                    b.HasOne("FinanceManagement.Domain.Entities.MiscMaster", "OldControlAccount")
                        .WithMany()
                        .HasForeignKey("OldControlAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FinanceManagement.Domain.Entities.TaxCodeMaster", "OldTaxCode")
                        .WithMany()
                        .HasForeignKey("OldTaxCodeId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("OldControlAccount");

                    b.Navigation("OldTaxCode");
