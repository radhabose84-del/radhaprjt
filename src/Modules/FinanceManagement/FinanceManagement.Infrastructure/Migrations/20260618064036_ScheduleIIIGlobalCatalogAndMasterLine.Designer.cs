...
namespace FinanceManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260618064036_ScheduleIIIGlobalCatalogAndMasterLine")]
    partial class ScheduleIIIGlobalCatalogAndMasterLine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.ScheduleIIIMasterLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ScheduleIIIMasterId")
                        .HasColumnType("int")
                        .HasColumnName("ScheduleIIIMasterId");

                    b.HasKey("Id");

                    b.HasIndex("ScheduleIIILineItemId");

                    b.HasIndex("ScheduleIIIMasterId", "ScheduleIIILineItemId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("ScheduleIIIMasterLine", "Finance");
                });
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.ScheduleIIISubTotal", b =>
                {
                    ...
                    b.HasIndex("ScheduleIIIMasterId");
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.ScheduleIIIMasterLine", b =>
                {
                    b.HasOne("FinanceManagement.Domain.Entities.ScheduleIIILineItem", "ScheduleIIILineItem")
                        .WithMany("MasterLines")
                        .HasForeignKey("ScheduleIIILineItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FinanceManagement.Domain.Entities.ScheduleIIIMaster", "ScheduleIIIMaster")
                        .WithMany("MasterLines")
                        .HasForeignKey("ScheduleIIIMasterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ScheduleIIILineItem");

                    b.Navigation("ScheduleIIIMaster");
                });
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.ScheduleIIISubTotal", b =>
                {
                    b.HasOne("FinanceManagement.Domain.Entities.ScheduleIIIMaster", "Structure")
                        .WithMany("SubTotals")
                        .HasForeignKey("ScheduleIIIMasterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
