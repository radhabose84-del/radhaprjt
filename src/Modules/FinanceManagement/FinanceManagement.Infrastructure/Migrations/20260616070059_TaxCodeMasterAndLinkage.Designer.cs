...
namespace FinanceManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260616070059_TaxCodeMasterAndLinkage")]
    partial class TaxCodeMasterAndLinkage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.GstrSectionMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("GstrType")
                        .IsRequired()
                        .HasColumnType("varchar(10)")
                        .HasColumnName("GstrType");
                    ...
                    b.HasIndex("CompanyId", "GstrType", "SectionCode")
                        .IsUnique()
                        .HasDatabaseName("UX_GstrSectionMapping_Section")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("GstrSectionMapping", "Finance", t =>
                        {
                            t.HasCheckConstraint("CK_GSM_Tolerance", "[TolerancePercent] IS NULL OR [TolerancePercent] >= 0");
                    ...
                    b.ToTable("TaxAccountLinkage", "Finance", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_TAL_Status", "[ApprovalStatus] IN ('PENDING','APPROVED','REJECTED')");
                        });
                });
            ...
            modelBuilder.Entity("FinanceManagement.Domain.Entities.TaxCodeMaster", b =>
                {
                    ...
                    b.HasIndex("TaxType")
                        .HasDatabaseName("IX_TaxCodeMaster_TaxType");
                    ...
                    b.ToTable("TaxCodeMaster", "Finance", t =>
                        {
                            t.HasCheckConstraint("CK_TCM_Component", "[TaxComponent] IN ('COMBINED','CGST','SGST','IGST','CESS','NA')");

                            t.HasCheckConstraint("CK_TCM_Direction", "[Direction] IS NULL OR [Direction] IN ('INPUT','OUTPUT')");

                            t.HasCheckConstraint("CK_TCM_ParentLink", "([TaxComponent] IN ('CGST','SGST','IGST','CESS') AND [ParentTaxCodeId] IS NOT NULL) OR ([TaxComponent] IN ('COMBINED','NA') AND [ParentTaxCodeId] IS NULL)");

                            t.HasCheckConstraint("CK_TCM_TaxType", "[TaxType] IN ('GST_IN','GST_OUT','IGST','TDS','CUSTOMS')");
