...
namespace FinanceManagement.Presentation.Validation.MiscTypeMaster
{
    public class CreateMiscTypeMasterCommandValidator : AbstractValidator<CreateMiscTypeMasterCommand>
    {
            ...
            IMiscTypeMasterQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<FinanceManagement.Domain.Entities.MiscTypeMaster>("MiscTypeCode") ?? 20;
            var maxLengthDescription = maxLengthProvider.GetMaxLength<FinanceManagement.Domain.Entities.MiscTypeMaster>("Description") ?? 250;
