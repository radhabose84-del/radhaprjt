...
namespace FinanceManagement.Presentation.Validation.MiscMaster
{
    public class CreateMiscMasterCommandValidator : AbstractValidator<CreateMiscMasterCommand>
    {
            ...
            IMiscMasterQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<FinanceManagement.Domain.Entities.MiscMaster>("Code") ?? 20;
            var maxLengthDescription = maxLengthProvider.GetMaxLength<FinanceManagement.Domain.Entities.MiscMaster>("Description") ?? 250;
