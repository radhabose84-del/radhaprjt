...
{
    public class CreateRecurringJournalTemplateCommandValidator : AbstractValidator<CreateRecurringJournalTemplateCommand>
    {
        private readonly IRecurringJournalTemplateQueryRepository _queryRepository;
        private readonly IIPAddressService _ipAddressService;

        public CreateRecurringJournalTemplateCommandValidator(
            ...
            IIPAddressService ipAddressService)
        {
            ...
            RuleFor(x => x.TemplateName)
                .MustAsync(async (name, ct) => !await _queryRepository.AlreadyExistsByNameAsync(name!))
        ...
        private async Task<bool> AllAccountsExistAsync(CreateRecurringJournalTemplateCommand command, CancellationToken ct)
        {
