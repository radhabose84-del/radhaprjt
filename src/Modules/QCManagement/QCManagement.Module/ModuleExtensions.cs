using QCManagement.Application.Common.Mappings;
...
namespace QCManagement.Module
{
    public static class ModuleExtensions
    {
        public static IServiceCollection AddQCManagementModule(
            this IServiceCollection services,
            IConfiguration configuration,
            IHostEnvironment env)
        {
            // ✅ 0) Infrastructure FIRST (DbContext + repos + services)
            services.AddQCInfrastructureServices(configuration, env);
