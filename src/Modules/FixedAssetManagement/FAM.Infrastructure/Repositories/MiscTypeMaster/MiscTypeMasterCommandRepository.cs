...
namespace FAM.Infrastructure.Repositories.MiscTypeMaster
{
    public class MiscTypeMasterCommandRepository    : IMiscTypeMasterCommandRepository
    {
     ...
     public async   Task<FAM.Domain.Entities.MiscTypeMaster> CreateAsync(FAM.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
          ...
          public async Task<bool> UpdateAsync(int id,FAM.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id,FAM.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
