...
namespace MaintenanceManagement.Infrastructure.Repositories.MiscMaster
{
  public class MiscMasterCommandRepository : IMiscMasterCommandRepository
  {
    ...
    public async Task<MaintenanceManagement.Domain.Entities.MiscMaster> CreateAsync(MaintenanceManagement.Domain.Entities.MiscMaster miscMaster)
    {
    ...
    public async Task<bool> UpdateAsync(int id, MaintenanceManagement.Domain.Entities.MiscMaster miscMaster)
    {
    ...
    public async Task<bool> DeleteAsync(int id, MaintenanceManagement.Domain.Entities.MiscMaster miscMaster)
    {
