...
namespace MaintenanceManagement.Infrastructure.Repositories.MiscTypeMaster
{
    public class MiscTypeMasterCommandRepository    : IMiscTypeMasterCommandRepository
    {
     ...
     public async   Task<MaintenanceManagement.Domain.Entities.MiscTypeMaster> CreateAsync(MaintenanceManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
          ...
          public async Task<bool> UpdateAsync(int id,MaintenanceManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id,MaintenanceManagement.Domain.Entities.MiscTypeMaster miscTypeMaster)
        {
