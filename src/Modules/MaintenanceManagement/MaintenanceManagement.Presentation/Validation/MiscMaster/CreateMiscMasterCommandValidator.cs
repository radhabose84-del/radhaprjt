...
namespace MaintenanceManagement.Presentation.Validation.MiscMaster
{
    public class CreateMiscMasterCommandValidator  : AbstractValidator<CreateMiscMasterCommand>
    {
         ...
         public CreateMiscMasterCommandValidator( IMiscMasterQueryRepository miscMasterQuery,MaxLengthProvider maxLengthProvider)
        {
            ...
            var MiscCodeMaxLength = maxLengthProvider.GetMaxLength<MaintenanceManagement.Domain.Entities.MiscMaster>("Code") ?? 50;
            var DescriptionMaxLength = maxLengthProvider.GetMaxLength<MaintenanceManagement.Domain.Entities.MiscMaster>("Description")?? 250;
