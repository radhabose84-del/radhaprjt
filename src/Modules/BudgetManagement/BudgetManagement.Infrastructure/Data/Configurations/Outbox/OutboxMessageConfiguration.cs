...
namespace BudgetManagement.Infrastructure.Data.Configurations.Outbox
{
    public class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
    {
        public void Configure(EntityTypeBuilder<OutboxMessage> builder)
        {
            builder.ToTable("OutboxMessages", "Budget");
            ...
            builder.Property(x => x.ModuleName).HasMaxLength(100).HasDefaultValue("BudgetManagement");
