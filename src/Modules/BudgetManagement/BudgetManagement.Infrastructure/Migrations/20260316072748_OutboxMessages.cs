        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "BudgetManagement"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budget_OutboxMessages_CorrelationId",
                schema: "Budget",
                table: "OutboxMessages",
                column: "CorrelationId");

            migrationBuilder.CreateIndex(
                name: "IX_Budget_OutboxMessages_CreatedAt",
                schema: "Budget",
                table: "OutboxMessages",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Budget_OutboxMessages_Status_NextRetryAt",
                schema: "Budget",
                table: "OutboxMessages",
