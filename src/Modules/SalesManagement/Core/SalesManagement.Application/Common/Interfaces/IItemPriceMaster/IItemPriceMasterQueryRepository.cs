...
namespace SalesManagement.Application.Common.Interfaces.IItemPriceMaster
{
    public interface IItemPriceMasterQueryRepository
    {
        ...
        Task<bool> OverlapExistsAsync(int itemId, int? variantId, int salesSegmentId,
        ...
        Task<List<ExMillRateDto>> GetExMillRateByPaymentTermAsync(int? paymentTermId, int itemId, DateOnly date, int? salesSegmentId = null);
    }
}
