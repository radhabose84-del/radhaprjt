...
{
    public class SalesItemPriceMasterConfiguration : IEntityTypeConfiguration<SalesItemPriceMaster>
    {
        public void Configure(EntityTypeBuilder<SalesItemPriceMaster> builder)
        {
            ...
            builder.ToTable("SalesItemPriceMaster", "Sales");
