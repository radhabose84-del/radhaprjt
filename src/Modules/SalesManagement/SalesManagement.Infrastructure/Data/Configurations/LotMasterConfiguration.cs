...
namespace SalesManagement.Infrastructure.Data.Configurations
{
    public class LotMasterConfiguration : IEntityTypeConfiguration<LotMaster>
    {
        public void Configure(EntityTypeBuilder<LotMaster> builder)
        {
            ...
            builder.ToTable("LotMaster", "Sales");
            ...
            builder.Property(t => t.LotTypeId)
            ...
            builder.Property(t => t.ProductionOrderRef)
                .HasColumnName("ProductionOrderRef")
                .HasColumnType("varchar(50)")
                .IsRequired(false);

            builder.Property(t => t.TotalProducedQty)
            ...
            builder.Property(t => t.RunOutDate)
            ...
            // Same-module FK — MiscMaster for LotType (DB constraint)
            builder.HasOne(t => t.LotTypeMisc)
                .WithMany(m => m.LotMastersAsLotType)
                .HasForeignKey(t => t.LotTypeId)
                .OnDelete(DeleteBehavior.Restrict);

            // Same-module FK — MiscMaster for Status (DB constraint)
            builder.HasOne(t => t.StatusMisc)
                .WithMany(m => m.LotMastersAsStatus)
                .HasForeignKey(t => t.StatusId)
                .OnDelete(DeleteBehavior.Restrict);

            // Cross-module FKs (ItemId, UnitId) — NO DB FK constraints
        }
    }
}
