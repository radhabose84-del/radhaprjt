...
namespace SalesManagement.Infrastructure.Data.Configurations
{
    public class InvoiceDetailConfiguration : IEntityTypeConfiguration<InvoiceDetail>
    {
        public void Configure(EntityTypeBuilder<InvoiceDetail> builder)
        {
            ...
            builder.Property(t => t.NoOfBags).HasColumnName("NoOfBags").HasColumnType("decimal(18,6)").IsRequired();
            builder.Property(t => t.BagWeight).HasColumnName("BagWeight").HasColumnType("decimal(18,6)").IsRequired();
            builder.Property(t => t.NetWeight).HasColumnName("NetWeight").HasColumnType("decimal(18,6)").IsRequired();
