...
namespace SalesManagement.Infrastructure.Repositories.Production
{
    public class ProductionCommandRepository : IProductionCommandRepository
    {
        ...
        public async Task<string> GenerateNextPackNoAsync(int warehouseId, CancellationToken ct = default)
        {
