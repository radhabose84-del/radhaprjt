...
namespace SalesManagement.Presentation.Validation.PackType
{
    public class CreatePackTypeCommandValidator : AbstractValidator<CreatePackTypeCommand>
    {
            ...
            IPackTypeQueryRepository queryRepository)
        {
            ...
            var maxLengthCode = maxLengthProvider.GetMaxLength<SalesManagement.Domain.Entities.PackType>("PackTypeCode") ?? 20;
            var maxLengthName = maxLengthProvider.GetMaxLength<SalesManagement.Domain.Entities.PackType>("PackTypeName") ?? 100;
