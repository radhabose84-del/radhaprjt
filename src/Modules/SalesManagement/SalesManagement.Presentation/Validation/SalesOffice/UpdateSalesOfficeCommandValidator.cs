...
namespace SalesManagement.Presentation.Validation.SalesOffice
{
    public class UpdateSalesOfficeCommandValidator : AbstractValidator<UpdateSalesOfficeCommand>
    {
        ...
        public UpdateSalesOfficeCommandValidator(ISalesOfficeQueryRepository queryRepository)
        {
            ...
            // Uniqueness: SalesOfficeName within SalesOrganisation (exclude self) (BR-2)
            RuleFor(x => x)
