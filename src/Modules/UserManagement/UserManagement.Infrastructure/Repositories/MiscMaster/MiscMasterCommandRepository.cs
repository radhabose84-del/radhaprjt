...
namespace UserManagement.Infrastructure.Repositories.MiscMaster
{
    public class MiscMasterCommandRepository: IMiscMasterCommandRepository
  {
        ...
        public async Task<UserManagement.Domain.Entities.MiscMaster> CreateAsync(UserManagement.Domain.Entities.MiscMaster miscMaster)
        {
        ...
        public async Task<bool> UpdateAsync(int id, UserManagement.Domain.Entities.MiscMaster miscMaster)
        {
        ...
        public async Task<bool> DeleteAsync(int id, UserManagement.Domain.Entities.MiscMaster miscMaster)
        {
