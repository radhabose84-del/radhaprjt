...
{
    internal class DivisionUnitLookupRepository : IDivisionUnitLookup
    {
        private readonly IDbConnection _dbConnection;

        public DivisionUnitLookupRepository(IDbConnection dbConnection)
        {
            _dbConnection = dbConnection;
        }

        public async Task<List<DivisionUnitLookupDto>> GetUnitsByDivisionAsync(
            int companyId,
            int divisionId,
