...
namespace BSOFT.Infrastructure.Migrations
{
    ...
    [Migration("20260626113954_FinancialYear_StatusAndTransition")]
    partial class FinancialYear_StatusAndTransition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomFieldMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomFieldOptionalValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomFieldUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.DepartmentGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.Station", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.Unit", b =>
                {
                    ...
                    b.Property<bool>("IsMaintenanceStopStart")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("SpindlesCapacity")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.UserDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.UserSignature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserSignature", "AppData");
                });
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomField", b =>
                {
                    b.HasOne("UserManagement.Domain.Entities.MiscMaster", "DataType")
                        .WithMany("CustomFieldDataTypes")
                        .HasForeignKey("DataTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("UserManagement.Domain.Entities.MiscMaster", "LabelType")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.CustomFieldMenu", b =>
                {
                    b.HasOne("UserManagement.Domain.Entities.CustomField", "CustomField")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.Department", b =>
                {
                    b.HasOne("UserManagement.Domain.Entities.DepartmentGroup", "DepartmentGroup")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.FinancialYear", b =>
                {
                    b.HasOne("UserManagement.Domain.Entities.MiscMaster", "StatusMaster")
            ...
            modelBuilder.Entity("UserManagement.Domain.Entities.MiscMaster", b =>
                {
                    b.HasOne("UserManagement.Domain.Entities.MiscTypeMaster", "MiscTypeMaster")
                        .WithMany("MiscMaster")
